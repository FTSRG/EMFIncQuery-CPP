#ifndef VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_59_H_
#define VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_59_H_
...
class TrainHitsAnotherTrainFrame_59Vector;

struct TrainHitsAnotherTrainFrame_59 {
	
	using PBFrame = PB_TrainHitsAnotherTrainFrame_59;
	using FrameVector = TrainHitsAnotherTrainFrame_59Vector;
	...
	{
		PB_TrainHitsAnotherTrainFrame_59 pbframe;
...
class TrainHitsAnotherTrainFrame_59Vector 
	: private std::vector<TrainHitsAnotherTrainFrame_59>
{
	public:
	using std::vector<TrainHitsAnotherTrainFrame_59>::push_back;
	using std::vector<TrainHitsAnotherTrainFrame_59>::clear;
	using std::vector<TrainHitsAnotherTrainFrame_59>::empty;
	using std::vector<TrainHitsAnotherTrainFrame_59>::size;
	using std::vector<TrainHitsAnotherTrainFrame_59>::begin;
	using std::vector<TrainHitsAnotherTrainFrame_59>::end;
	...
	{
		PB_TrainHitsAnotherTrainFrame_59Vector pbFrameVector;
...
#endif /*  VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_59_H_ */
