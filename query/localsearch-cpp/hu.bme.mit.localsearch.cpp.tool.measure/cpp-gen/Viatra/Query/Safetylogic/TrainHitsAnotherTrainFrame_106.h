#ifndef VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_106_H_
#define VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_106_H_
...
class TrainHitsAnotherTrainFrame_106Vector;

struct TrainHitsAnotherTrainFrame_106 {
	
	using PBFrame = PB_TrainHitsAnotherTrainFrame_106;
	using FrameVector = TrainHitsAnotherTrainFrame_106Vector;
	...
	{
		PB_TrainHitsAnotherTrainFrame_106 pbframe;
...
class TrainHitsAnotherTrainFrame_106Vector 
	: private std::vector<TrainHitsAnotherTrainFrame_106>
{
	public:
	using std::vector<TrainHitsAnotherTrainFrame_106>::push_back;
	using std::vector<TrainHitsAnotherTrainFrame_106>::clear;
	using std::vector<TrainHitsAnotherTrainFrame_106>::empty;
	using std::vector<TrainHitsAnotherTrainFrame_106>::size;
	using std::vector<TrainHitsAnotherTrainFrame_106>::begin;
	using std::vector<TrainHitsAnotherTrainFrame_106>::end;
	...
	{
		PB_TrainHitsAnotherTrainFrame_106Vector pbFrameVector;
...
#endif /*  VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_106_H_ */
