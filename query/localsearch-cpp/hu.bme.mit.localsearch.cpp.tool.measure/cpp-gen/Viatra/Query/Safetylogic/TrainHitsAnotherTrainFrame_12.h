#ifndef VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_12_H_
#define VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_12_H_
...
class TrainHitsAnotherTrainFrame_12Vector;

struct TrainHitsAnotherTrainFrame_12 {
	
	using PBFrame = PB_TrainHitsAnotherTrainFrame_12;
	using FrameVector = TrainHitsAnotherTrainFrame_12Vector;
	...
	{
		PB_TrainHitsAnotherTrainFrame_12 pbframe;
...
class TrainHitsAnotherTrainFrame_12Vector 
	: private std::vector<TrainHitsAnotherTrainFrame_12>
{
	public:
	using std::vector<TrainHitsAnotherTrainFrame_12>::push_back;
	using std::vector<TrainHitsAnotherTrainFrame_12>::clear;
	using std::vector<TrainHitsAnotherTrainFrame_12>::empty;
	using std::vector<TrainHitsAnotherTrainFrame_12>::size;
	using std::vector<TrainHitsAnotherTrainFrame_12>::begin;
	using std::vector<TrainHitsAnotherTrainFrame_12>::end;
	...
	{
		PB_TrainHitsAnotherTrainFrame_12Vector pbFrameVector;
...
#endif /*  VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_12_H_ */
