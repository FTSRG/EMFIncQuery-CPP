#ifndef VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_65_H_
#define VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_65_H_
...
class TrainHitsAnotherTrainFrame_65Vector;

struct TrainHitsAnotherTrainFrame_65 {
	
	using PBFrame = PB_TrainHitsAnotherTrainFrame_65;
	using FrameVector = TrainHitsAnotherTrainFrame_65Vector;
	...
	{
		PB_TrainHitsAnotherTrainFrame_65 pbframe;
...
class TrainHitsAnotherTrainFrame_65Vector 
	: private std::vector<TrainHitsAnotherTrainFrame_65>
{
	public:
	using std::vector<TrainHitsAnotherTrainFrame_65>::push_back;
	using std::vector<TrainHitsAnotherTrainFrame_65>::clear;
	using std::vector<TrainHitsAnotherTrainFrame_65>::empty;
	using std::vector<TrainHitsAnotherTrainFrame_65>::size;
	using std::vector<TrainHitsAnotherTrainFrame_65>::begin;
	using std::vector<TrainHitsAnotherTrainFrame_65>::end;
	...
	{
		PB_TrainHitsAnotherTrainFrame_65Vector pbFrameVector;
...
#endif /*  VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_65_H_ */
