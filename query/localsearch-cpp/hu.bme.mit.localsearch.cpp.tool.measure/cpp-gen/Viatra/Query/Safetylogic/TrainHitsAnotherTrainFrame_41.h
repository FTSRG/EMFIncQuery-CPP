#ifndef VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_41_H_
#define VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_41_H_
...
class TrainHitsAnotherTrainFrame_41Vector;

struct TrainHitsAnotherTrainFrame_41 {
	
	using PBFrame = PB_TrainHitsAnotherTrainFrame_41;
	using FrameVector = TrainHitsAnotherTrainFrame_41Vector;
	...
	{
		PB_TrainHitsAnotherTrainFrame_41 pbframe;
...
class TrainHitsAnotherTrainFrame_41Vector 
	: private std::vector<TrainHitsAnotherTrainFrame_41>
{
	public:
	using std::vector<TrainHitsAnotherTrainFrame_41>::push_back;
	using std::vector<TrainHitsAnotherTrainFrame_41>::clear;
	using std::vector<TrainHitsAnotherTrainFrame_41>::empty;
	using std::vector<TrainHitsAnotherTrainFrame_41>::size;
	using std::vector<TrainHitsAnotherTrainFrame_41>::begin;
	using std::vector<TrainHitsAnotherTrainFrame_41>::end;
	...
	{
		PB_TrainHitsAnotherTrainFrame_41Vector pbFrameVector;
...
#endif /*  VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_41_H_ */
