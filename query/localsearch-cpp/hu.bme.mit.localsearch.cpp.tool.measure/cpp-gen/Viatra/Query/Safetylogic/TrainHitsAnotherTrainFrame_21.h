#ifndef VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_21_H_
#define VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_21_H_
...
class TrainHitsAnotherTrainFrame_21Vector;

struct TrainHitsAnotherTrainFrame_21 {
	
	using PBFrame = PB_TrainHitsAnotherTrainFrame_21;
	using FrameVector = TrainHitsAnotherTrainFrame_21Vector;
	...
	{
		PB_TrainHitsAnotherTrainFrame_21 pbframe;
...
class TrainHitsAnotherTrainFrame_21Vector 
	: private std::vector<TrainHitsAnotherTrainFrame_21>
{
	public:
	using std::vector<TrainHitsAnotherTrainFrame_21>::push_back;
	using std::vector<TrainHitsAnotherTrainFrame_21>::clear;
	using std::vector<TrainHitsAnotherTrainFrame_21>::empty;
	using std::vector<TrainHitsAnotherTrainFrame_21>::size;
	using std::vector<TrainHitsAnotherTrainFrame_21>::begin;
	using std::vector<TrainHitsAnotherTrainFrame_21>::end;
	...
	{
		PB_TrainHitsAnotherTrainFrame_21Vector pbFrameVector;
...
#endif /*  VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_21_H_ */
