#ifndef VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_35_H_
#define VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_35_H_
...
class TrainHitsAnotherTrainFrame_35Vector;

struct TrainHitsAnotherTrainFrame_35 {
	
	using PBFrame = PB_TrainHitsAnotherTrainFrame_35;
	using FrameVector = TrainHitsAnotherTrainFrame_35Vector;
	...
	{
		PB_TrainHitsAnotherTrainFrame_35 pbframe;
...
class TrainHitsAnotherTrainFrame_35Vector 
	: private std::vector<TrainHitsAnotherTrainFrame_35>
{
	public:
	using std::vector<TrainHitsAnotherTrainFrame_35>::push_back;
	using std::vector<TrainHitsAnotherTrainFrame_35>::clear;
	using std::vector<TrainHitsAnotherTrainFrame_35>::empty;
	using std::vector<TrainHitsAnotherTrainFrame_35>::size;
	using std::vector<TrainHitsAnotherTrainFrame_35>::begin;
	using std::vector<TrainHitsAnotherTrainFrame_35>::end;
	...
	{
		PB_TrainHitsAnotherTrainFrame_35Vector pbFrameVector;
...
#endif /*  VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_35_H_ */
