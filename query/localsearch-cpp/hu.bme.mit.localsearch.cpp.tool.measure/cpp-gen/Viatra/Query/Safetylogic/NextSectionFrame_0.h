#ifndef VIATRA__QUERY__SAFETYLOGIC__NEXT_SECTION_FRAME_0_H_
#define VIATRA__QUERY__SAFETYLOGIC__NEXT_SECTION_FRAME_0_H_
...
class NextSectionFrame_0Vector;

struct NextSectionFrame_0 {
	
	using PBFrame = PB_NextSectionFrame_0;
	using FrameVector = NextSectionFrame_0Vector;
...
class NextSectionFrame_0Vector 
	: private std::vector<NextSectionFrame_0>
{
	public:
	using std::vector<NextSectionFrame_0>::push_back;
	using std::vector<NextSectionFrame_0>::clear;
	using std::vector<NextSectionFrame_0>::empty;
	using std::vector<NextSectionFrame_0>::size;
	using std::vector<NextSectionFrame_0>::begin;
	using std::vector<NextSectionFrame_0>::end;
	...
	{
		PB_NextSectionFrame_0Vector pbFrameVector;
...
#endif /*  VIATRA__QUERY__SAFETYLOGIC__NEXT_SECTION_FRAME_0_H_ */
