#ifndef VIATRA__QUERY__SAFETYLOGIC__NEXT_SECTION_FRAME_7_H_
#define VIATRA__QUERY__SAFETYLOGIC__NEXT_SECTION_FRAME_7_H_
...
class NextSectionFrame_7Vector;

struct NextSectionFrame_7 {
	
	using PBFrame = PB_NextSectionFrame_7;
	using FrameVector = NextSectionFrame_7Vector;
...
class NextSectionFrame_7Vector 
	: private std::vector<NextSectionFrame_7>
{
	public:
	using std::vector<NextSectionFrame_7>::push_back;
	using std::vector<NextSectionFrame_7>::clear;
	using std::vector<NextSectionFrame_7>::empty;
	using std::vector<NextSectionFrame_7>::size;
	using std::vector<NextSectionFrame_7>::begin;
	using std::vector<NextSectionFrame_7>::end;
	...
	{
		PB_NextSectionFrame_7Vector pbFrameVector;
...
#endif /*  VIATRA__QUERY__SAFETYLOGIC__NEXT_SECTION_FRAME_7_H_ */
