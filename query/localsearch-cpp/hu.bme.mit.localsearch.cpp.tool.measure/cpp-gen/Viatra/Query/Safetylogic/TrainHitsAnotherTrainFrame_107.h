#ifndef VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_107_H_
#define VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_107_H_
...
class TrainHitsAnotherTrainFrame_107Vector;

struct TrainHitsAnotherTrainFrame_107 {
	
	using PBFrame = PB_TrainHitsAnotherTrainFrame_107;
	using FrameVector = TrainHitsAnotherTrainFrame_107Vector;
	...
	{
		PB_TrainHitsAnotherTrainFrame_107 pbframe;
...
class TrainHitsAnotherTrainFrame_107Vector 
	: private std::vector<TrainHitsAnotherTrainFrame_107>
{
	public:
	using std::vector<TrainHitsAnotherTrainFrame_107>::push_back;
	using std::vector<TrainHitsAnotherTrainFrame_107>::clear;
	using std::vector<TrainHitsAnotherTrainFrame_107>::empty;
	using std::vector<TrainHitsAnotherTrainFrame_107>::size;
	using std::vector<TrainHitsAnotherTrainFrame_107>::begin;
	using std::vector<TrainHitsAnotherTrainFrame_107>::end;
	...
	{
		PB_TrainHitsAnotherTrainFrame_107Vector pbFrameVector;
...
#endif /*  VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_107_H_ */
