#ifndef VIATRA__QUERY__SAFETYLOGIC__SHOULD_COLLIDE_MATCH_H_
#define VIATRA__QUERY__SAFETYLOGIC__SHOULD_COLLIDE_MATCH_H_
...
template<> struct hash<::Viatra::Query::Safetylogic::ShouldCollideMatch> {
	size_t operator()(const ::Viatra::Query::Safetylogic::ShouldCollideMatch& match) const {
		size_t h = 0;
...
#endif /*  VIATRA__QUERY__SAFETYLOGIC__SHOULD_COLLIDE_MATCH_H_ */
