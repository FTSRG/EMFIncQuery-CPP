#ifndef VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_22_H_
#define VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_22_H_
...
class TrainHitsAnotherTrainFrame_22Vector;

struct TrainHitsAnotherTrainFrame_22 {
	
	using PBFrame = PB_TrainHitsAnotherTrainFrame_22;
	using FrameVector = TrainHitsAnotherTrainFrame_22Vector;
	...
	{
		PB_TrainHitsAnotherTrainFrame_22 pbframe;
...
class TrainHitsAnotherTrainFrame_22Vector 
	: private std::vector<TrainHitsAnotherTrainFrame_22>
{
	public:
	using std::vector<TrainHitsAnotherTrainFrame_22>::push_back;
	using std::vector<TrainHitsAnotherTrainFrame_22>::clear;
	using std::vector<TrainHitsAnotherTrainFrame_22>::empty;
	using std::vector<TrainHitsAnotherTrainFrame_22>::size;
	using std::vector<TrainHitsAnotherTrainFrame_22>::begin;
	using std::vector<TrainHitsAnotherTrainFrame_22>::end;
	...
	{
		PB_TrainHitsAnotherTrainFrame_22Vector pbFrameVector;
...
#endif /*  VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_22_H_ */
