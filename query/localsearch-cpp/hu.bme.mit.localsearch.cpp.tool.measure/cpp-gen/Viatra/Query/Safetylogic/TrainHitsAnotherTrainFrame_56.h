#ifndef VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_56_H_
#define VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_56_H_
...
class TrainHitsAnotherTrainFrame_56Vector;

struct TrainHitsAnotherTrainFrame_56 {
	
	using PBFrame = PB_TrainHitsAnotherTrainFrame_56;
	using FrameVector = TrainHitsAnotherTrainFrame_56Vector;
	...
	{
		PB_TrainHitsAnotherTrainFrame_56 pbframe;
...
class TrainHitsAnotherTrainFrame_56Vector 
	: private std::vector<TrainHitsAnotherTrainFrame_56>
{
	public:
	using std::vector<TrainHitsAnotherTrainFrame_56>::push_back;
	using std::vector<TrainHitsAnotherTrainFrame_56>::clear;
	using std::vector<TrainHitsAnotherTrainFrame_56>::empty;
	using std::vector<TrainHitsAnotherTrainFrame_56>::size;
	using std::vector<TrainHitsAnotherTrainFrame_56>::begin;
	using std::vector<TrainHitsAnotherTrainFrame_56>::end;
	...
	{
		PB_TrainHitsAnotherTrainFrame_56Vector pbFrameVector;
...
#endif /*  VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_56_H_ */
