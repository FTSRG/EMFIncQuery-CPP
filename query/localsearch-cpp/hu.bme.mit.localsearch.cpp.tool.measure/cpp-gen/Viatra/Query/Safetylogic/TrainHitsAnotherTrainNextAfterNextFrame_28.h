#ifndef VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_NEXT_AFTER_NEXT_FRAME_28_H_
#define VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_NEXT_AFTER_NEXT_FRAME_28_H_
...
class TrainHitsAnotherTrainNextAfterNextFrame_28Vector;

struct TrainHitsAnotherTrainNextAfterNextFrame_28 {
	
	using PBFrame = PB_TrainHitsAnotherTrainNextAfterNextFrame_28;
	using FrameVector = TrainHitsAnotherTrainNextAfterNextFrame_28Vector;
	...
	::railRoadModel::ITurnout* _15 = nullptr;
	// toString
	...
	{
		PB_TrainHitsAnotherTrainNextAfterNextFrame_28 pbframe;
	...
	void ParseFromString(std::string str, ModelRoot *mr)
	{
		...
		_15 = (pbframe._15() == -1) 
			? nullptr 
			: dynamic_cast<::railRoadModel::ITurnout*>(mr->findModelElementByID(pbframe._15()));
		
	}
};
		
class TrainHitsAnotherTrainNextAfterNextFrame_28Vector 
	: private std::vector<TrainHitsAnotherTrainNextAfterNextFrame_28>
{
	public:
	using std::vector<TrainHitsAnotherTrainNextAfterNextFrame_28>::push_back;
	using std::vector<TrainHitsAnotherTrainNextAfterNextFrame_28>::clear;
	using std::vector<TrainHitsAnotherTrainNextAfterNextFrame_28>::empty;
	using std::vector<TrainHitsAnotherTrainNextAfterNextFrame_28>::size;
	using std::vector<TrainHitsAnotherTrainNextAfterNextFrame_28>::begin;
	using std::vector<TrainHitsAnotherTrainNextAfterNextFrame_28>::end;
	...
	{
		PB_TrainHitsAnotherTrainNextAfterNextFrame_28Vector pbFrameVector;
...
#endif /*  VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_NEXT_AFTER_NEXT_FRAME_28_H_ */
