#ifndef VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_46_H_
#define VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_46_H_
...
class TrainHitsAnotherTrainFrame_46Vector;

struct TrainHitsAnotherTrainFrame_46 {
	
	using PBFrame = PB_TrainHitsAnotherTrainFrame_46;
	using FrameVector = TrainHitsAnotherTrainFrame_46Vector;
	...
	{
		PB_TrainHitsAnotherTrainFrame_46 pbframe;
...
class TrainHitsAnotherTrainFrame_46Vector 
	: private std::vector<TrainHitsAnotherTrainFrame_46>
{
	public:
	using std::vector<TrainHitsAnotherTrainFrame_46>::push_back;
	using std::vector<TrainHitsAnotherTrainFrame_46>::clear;
	using std::vector<TrainHitsAnotherTrainFrame_46>::empty;
	using std::vector<TrainHitsAnotherTrainFrame_46>::size;
	using std::vector<TrainHitsAnotherTrainFrame_46>::begin;
	using std::vector<TrainHitsAnotherTrainFrame_46>::end;
	...
	{
		PB_TrainHitsAnotherTrainFrame_46Vector pbFrameVector;
...
#endif /*  VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_46_H_ */
