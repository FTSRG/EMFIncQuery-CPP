#ifndef VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_29_H_
#define VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_29_H_
...
class TrainHitsAnotherTrainFrame_29Vector;

struct TrainHitsAnotherTrainFrame_29 {
	
	using PBFrame = PB_TrainHitsAnotherTrainFrame_29;
	using FrameVector = TrainHitsAnotherTrainFrame_29Vector;
	...
	{
		PB_TrainHitsAnotherTrainFrame_29 pbframe;
...
class TrainHitsAnotherTrainFrame_29Vector 
	: private std::vector<TrainHitsAnotherTrainFrame_29>
{
	public:
	using std::vector<TrainHitsAnotherTrainFrame_29>::push_back;
	using std::vector<TrainHitsAnotherTrainFrame_29>::clear;
	using std::vector<TrainHitsAnotherTrainFrame_29>::empty;
	using std::vector<TrainHitsAnotherTrainFrame_29>::size;
	using std::vector<TrainHitsAnotherTrainFrame_29>::begin;
	using std::vector<TrainHitsAnotherTrainFrame_29>::end;
	...
	{
		PB_TrainHitsAnotherTrainFrame_29Vector pbFrameVector;
...
#endif /*  VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_29_H_ */
