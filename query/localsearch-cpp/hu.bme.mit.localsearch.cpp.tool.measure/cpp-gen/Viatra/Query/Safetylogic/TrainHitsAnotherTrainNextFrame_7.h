#ifndef VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_NEXT_FRAME_7_H_
#define VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_NEXT_FRAME_7_H_
...
class TrainHitsAnotherTrainNextFrame_7Vector;

struct TrainHitsAnotherTrainNextFrame_7 {
	
	using PBFrame = PB_TrainHitsAnotherTrainNextFrame_7;
	using FrameVector = TrainHitsAnotherTrainNextFrame_7Vector;
	...
	{
		PB_TrainHitsAnotherTrainNextFrame_7 pbframe;
...
class TrainHitsAnotherTrainNextFrame_7Vector 
	: private std::vector<TrainHitsAnotherTrainNextFrame_7>
{
	public:
	using std::vector<TrainHitsAnotherTrainNextFrame_7>::push_back;
	using std::vector<TrainHitsAnotherTrainNextFrame_7>::clear;
	using std::vector<TrainHitsAnotherTrainNextFrame_7>::empty;
	using std::vector<TrainHitsAnotherTrainNextFrame_7>::size;
	using std::vector<TrainHitsAnotherTrainNextFrame_7>::begin;
	using std::vector<TrainHitsAnotherTrainNextFrame_7>::end;
	...
	{
		PB_TrainHitsAnotherTrainNextFrame_7Vector pbFrameVector;
...
#endif /*  VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_NEXT_FRAME_7_H_ */
