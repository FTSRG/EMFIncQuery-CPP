#ifndef VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_104_H_
#define VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_104_H_
...
class TrainHitsAnotherTrainFrame_104Vector;

struct TrainHitsAnotherTrainFrame_104 {
	
	using PBFrame = PB_TrainHitsAnotherTrainFrame_104;
	using FrameVector = TrainHitsAnotherTrainFrame_104Vector;
	...
	{
		PB_TrainHitsAnotherTrainFrame_104 pbframe;
...
class TrainHitsAnotherTrainFrame_104Vector 
	: private std::vector<TrainHitsAnotherTrainFrame_104>
{
	public:
	using std::vector<TrainHitsAnotherTrainFrame_104>::push_back;
	using std::vector<TrainHitsAnotherTrainFrame_104>::clear;
	using std::vector<TrainHitsAnotherTrainFrame_104>::empty;
	using std::vector<TrainHitsAnotherTrainFrame_104>::size;
	using std::vector<TrainHitsAnotherTrainFrame_104>::begin;
	using std::vector<TrainHitsAnotherTrainFrame_104>::end;
	...
	{
		PB_TrainHitsAnotherTrainFrame_104Vector pbFrameVector;
...
#endif /*  VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_104_H_ */
