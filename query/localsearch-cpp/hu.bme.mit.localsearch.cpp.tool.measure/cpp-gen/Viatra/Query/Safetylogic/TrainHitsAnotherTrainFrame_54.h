#ifndef VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_54_H_
#define VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_54_H_
...
class TrainHitsAnotherTrainFrame_54Vector;

struct TrainHitsAnotherTrainFrame_54 {
	
	using PBFrame = PB_TrainHitsAnotherTrainFrame_54;
	using FrameVector = TrainHitsAnotherTrainFrame_54Vector;
	...
	{
		PB_TrainHitsAnotherTrainFrame_54 pbframe;
...
class TrainHitsAnotherTrainFrame_54Vector 
	: private std::vector<TrainHitsAnotherTrainFrame_54>
{
	public:
	using std::vector<TrainHitsAnotherTrainFrame_54>::push_back;
	using std::vector<TrainHitsAnotherTrainFrame_54>::clear;
	using std::vector<TrainHitsAnotherTrainFrame_54>::empty;
	using std::vector<TrainHitsAnotherTrainFrame_54>::size;
	using std::vector<TrainHitsAnotherTrainFrame_54>::begin;
	using std::vector<TrainHitsAnotherTrainFrame_54>::end;
	...
	{
		PB_TrainHitsAnotherTrainFrame_54Vector pbFrameVector;
...
#endif /*  VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_54_H_ */
