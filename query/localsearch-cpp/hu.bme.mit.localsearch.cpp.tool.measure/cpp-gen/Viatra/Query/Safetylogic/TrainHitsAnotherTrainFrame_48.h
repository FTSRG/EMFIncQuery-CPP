#ifndef VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_48_H_
#define VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_48_H_
...
class TrainHitsAnotherTrainFrame_48Vector;

struct TrainHitsAnotherTrainFrame_48 {
	
	using PBFrame = PB_TrainHitsAnotherTrainFrame_48;
	using FrameVector = TrainHitsAnotherTrainFrame_48Vector;
	...
	{
		PB_TrainHitsAnotherTrainFrame_48 pbframe;
...
class TrainHitsAnotherTrainFrame_48Vector 
	: private std::vector<TrainHitsAnotherTrainFrame_48>
{
	public:
	using std::vector<TrainHitsAnotherTrainFrame_48>::push_back;
	using std::vector<TrainHitsAnotherTrainFrame_48>::clear;
	using std::vector<TrainHitsAnotherTrainFrame_48>::empty;
	using std::vector<TrainHitsAnotherTrainFrame_48>::size;
	using std::vector<TrainHitsAnotherTrainFrame_48>::begin;
	using std::vector<TrainHitsAnotherTrainFrame_48>::end;
	...
	{
		PB_TrainHitsAnotherTrainFrame_48Vector pbFrameVector;
...
#endif /*  VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_48_H_ */
