#ifndef VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_89_H_
#define VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_89_H_
...
class TrainHitsAnotherTrainFrame_89Vector;

struct TrainHitsAnotherTrainFrame_89 {
	
	using PBFrame = PB_TrainHitsAnotherTrainFrame_89;
	using FrameVector = TrainHitsAnotherTrainFrame_89Vector;
	...
	{
		PB_TrainHitsAnotherTrainFrame_89 pbframe;
...
class TrainHitsAnotherTrainFrame_89Vector 
	: private std::vector<TrainHitsAnotherTrainFrame_89>
{
	public:
	using std::vector<TrainHitsAnotherTrainFrame_89>::push_back;
	using std::vector<TrainHitsAnotherTrainFrame_89>::clear;
	using std::vector<TrainHitsAnotherTrainFrame_89>::empty;
	using std::vector<TrainHitsAnotherTrainFrame_89>::size;
	using std::vector<TrainHitsAnotherTrainFrame_89>::begin;
	using std::vector<TrainHitsAnotherTrainFrame_89>::end;
	...
	{
		PB_TrainHitsAnotherTrainFrame_89Vector pbFrameVector;
...
#endif /*  VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_89_H_ */
