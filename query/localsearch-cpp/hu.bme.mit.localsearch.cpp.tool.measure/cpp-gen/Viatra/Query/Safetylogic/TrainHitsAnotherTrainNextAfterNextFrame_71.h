#ifndef VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_NEXT_AFTER_NEXT_FRAME_71_H_
#define VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_NEXT_AFTER_NEXT_FRAME_71_H_
...
class TrainHitsAnotherTrainNextAfterNextFrame_71Vector;

struct TrainHitsAnotherTrainNextAfterNextFrame_71 {
	
	using PBFrame = PB_TrainHitsAnotherTrainNextAfterNextFrame_71;
	using FrameVector = TrainHitsAnotherTrainNextAfterNextFrame_71Vector;
	...
	::railRoadModel::ITurnout* _7 = nullptr;
	...
	{
		PB_TrainHitsAnotherTrainNextAfterNextFrame_71 pbframe;
	...
	void ParseFromString(std::string str, ModelRoot *mr)
	{
		...
		_7 = (pbframe._7() == -1) 
			? nullptr 
			: dynamic_cast<::railRoadModel::ITurnout*>(mr->findModelElementByID(pbframe._7()));
...
class TrainHitsAnotherTrainNextAfterNextFrame_71Vector 
	: private std::vector<TrainHitsAnotherTrainNextAfterNextFrame_71>
{
	public:
	using std::vector<TrainHitsAnotherTrainNextAfterNextFrame_71>::push_back;
	using std::vector<TrainHitsAnotherTrainNextAfterNextFrame_71>::clear;
	using std::vector<TrainHitsAnotherTrainNextAfterNextFrame_71>::empty;
	using std::vector<TrainHitsAnotherTrainNextAfterNextFrame_71>::size;
	using std::vector<TrainHitsAnotherTrainNextAfterNextFrame_71>::begin;
	using std::vector<TrainHitsAnotherTrainNextAfterNextFrame_71>::end;
	...
	{
		PB_TrainHitsAnotherTrainNextAfterNextFrame_71Vector pbFrameVector;
...
#endif /*  VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_NEXT_AFTER_NEXT_FRAME_71_H_ */
