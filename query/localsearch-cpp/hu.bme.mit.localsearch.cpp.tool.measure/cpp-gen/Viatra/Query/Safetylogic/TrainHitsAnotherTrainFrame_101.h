#ifndef VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_101_H_
#define VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_101_H_
...
class TrainHitsAnotherTrainFrame_101Vector;

struct TrainHitsAnotherTrainFrame_101 {
	
	using PBFrame = PB_TrainHitsAnotherTrainFrame_101;
	using FrameVector = TrainHitsAnotherTrainFrame_101Vector;
	...
	{
		PB_TrainHitsAnotherTrainFrame_101 pbframe;
...
class TrainHitsAnotherTrainFrame_101Vector 
	: private std::vector<TrainHitsAnotherTrainFrame_101>
{
	public:
	using std::vector<TrainHitsAnotherTrainFrame_101>::push_back;
	using std::vector<TrainHitsAnotherTrainFrame_101>::clear;
	using std::vector<TrainHitsAnotherTrainFrame_101>::empty;
	using std::vector<TrainHitsAnotherTrainFrame_101>::size;
	using std::vector<TrainHitsAnotherTrainFrame_101>::begin;
	using std::vector<TrainHitsAnotherTrainFrame_101>::end;
	...
	{
		PB_TrainHitsAnotherTrainFrame_101Vector pbFrameVector;
...
#endif /*  VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_101_H_ */
