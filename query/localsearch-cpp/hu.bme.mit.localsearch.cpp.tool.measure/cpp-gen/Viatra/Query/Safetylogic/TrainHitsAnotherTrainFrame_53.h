#ifndef VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_53_H_
#define VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_53_H_
...
class TrainHitsAnotherTrainFrame_53Vector;

struct TrainHitsAnotherTrainFrame_53 {
	
	using PBFrame = PB_TrainHitsAnotherTrainFrame_53;
	using FrameVector = TrainHitsAnotherTrainFrame_53Vector;
	...
	{
		PB_TrainHitsAnotherTrainFrame_53 pbframe;
...
class TrainHitsAnotherTrainFrame_53Vector 
	: private std::vector<TrainHitsAnotherTrainFrame_53>
{
	public:
	using std::vector<TrainHitsAnotherTrainFrame_53>::push_back;
	using std::vector<TrainHitsAnotherTrainFrame_53>::clear;
	using std::vector<TrainHitsAnotherTrainFrame_53>::empty;
	using std::vector<TrainHitsAnotherTrainFrame_53>::size;
	using std::vector<TrainHitsAnotherTrainFrame_53>::begin;
	using std::vector<TrainHitsAnotherTrainFrame_53>::end;
	...
	{
		PB_TrainHitsAnotherTrainFrame_53Vector pbFrameVector;
...
#endif /*  VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_53_H_ */
