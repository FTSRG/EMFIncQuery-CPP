#ifndef VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_82_H_
#define VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_82_H_
...
class TrainHitsAnotherTrainFrame_82Vector;

struct TrainHitsAnotherTrainFrame_82 {
	
	using PBFrame = PB_TrainHitsAnotherTrainFrame_82;
	using FrameVector = TrainHitsAnotherTrainFrame_82Vector;
	...
	{
		PB_TrainHitsAnotherTrainFrame_82 pbframe;
...
class TrainHitsAnotherTrainFrame_82Vector 
	: private std::vector<TrainHitsAnotherTrainFrame_82>
{
	public:
	using std::vector<TrainHitsAnotherTrainFrame_82>::push_back;
	using std::vector<TrainHitsAnotherTrainFrame_82>::clear;
	using std::vector<TrainHitsAnotherTrainFrame_82>::empty;
	using std::vector<TrainHitsAnotherTrainFrame_82>::size;
	using std::vector<TrainHitsAnotherTrainFrame_82>::begin;
	using std::vector<TrainHitsAnotherTrainFrame_82>::end;
	...
	{
		PB_TrainHitsAnotherTrainFrame_82Vector pbFrameVector;
...
#endif /*  VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_82_H_ */
