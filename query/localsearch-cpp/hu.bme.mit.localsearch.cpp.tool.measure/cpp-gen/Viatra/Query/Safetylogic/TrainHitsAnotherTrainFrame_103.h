#ifndef VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_103_H_
#define VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_103_H_
...
class TrainHitsAnotherTrainFrame_103Vector;

struct TrainHitsAnotherTrainFrame_103 {
	
	using PBFrame = PB_TrainHitsAnotherTrainFrame_103;
	using FrameVector = TrainHitsAnotherTrainFrame_103Vector;
	...
	{
		PB_TrainHitsAnotherTrainFrame_103 pbframe;
...
class TrainHitsAnotherTrainFrame_103Vector 
	: private std::vector<TrainHitsAnotherTrainFrame_103>
{
	public:
	using std::vector<TrainHitsAnotherTrainFrame_103>::push_back;
	using std::vector<TrainHitsAnotherTrainFrame_103>::clear;
	using std::vector<TrainHitsAnotherTrainFrame_103>::empty;
	using std::vector<TrainHitsAnotherTrainFrame_103>::size;
	using std::vector<TrainHitsAnotherTrainFrame_103>::begin;
	using std::vector<TrainHitsAnotherTrainFrame_103>::end;
	...
	{
		PB_TrainHitsAnotherTrainFrame_103Vector pbFrameVector;
...
#endif /*  VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_103_H_ */
