#ifndef VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_38_H_
#define VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_38_H_
...
class TrainHitsAnotherTrainFrame_38Vector;

struct TrainHitsAnotherTrainFrame_38 {
	
	using PBFrame = PB_TrainHitsAnotherTrainFrame_38;
	using FrameVector = TrainHitsAnotherTrainFrame_38Vector;
	...
	{
		PB_TrainHitsAnotherTrainFrame_38 pbframe;
...
class TrainHitsAnotherTrainFrame_38Vector 
	: private std::vector<TrainHitsAnotherTrainFrame_38>
{
	public:
	using std::vector<TrainHitsAnotherTrainFrame_38>::push_back;
	using std::vector<TrainHitsAnotherTrainFrame_38>::clear;
	using std::vector<TrainHitsAnotherTrainFrame_38>::empty;
	using std::vector<TrainHitsAnotherTrainFrame_38>::size;
	using std::vector<TrainHitsAnotherTrainFrame_38>::begin;
	using std::vector<TrainHitsAnotherTrainFrame_38>::end;
	...
	{
		PB_TrainHitsAnotherTrainFrame_38Vector pbFrameVector;
...
#endif /*  VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_38_H_ */
