#ifndef VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_15_H_
#define VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_15_H_
...
class TrainHitsAnotherTrainFrame_15Vector;

struct TrainHitsAnotherTrainFrame_15 {
	
	using PBFrame = PB_TrainHitsAnotherTrainFrame_15;
	using FrameVector = TrainHitsAnotherTrainFrame_15Vector;
	...
	{
		PB_TrainHitsAnotherTrainFrame_15 pbframe;
...
class TrainHitsAnotherTrainFrame_15Vector 
	: private std::vector<TrainHitsAnotherTrainFrame_15>
{
	public:
	using std::vector<TrainHitsAnotherTrainFrame_15>::push_back;
	using std::vector<TrainHitsAnotherTrainFrame_15>::clear;
	using std::vector<TrainHitsAnotherTrainFrame_15>::empty;
	using std::vector<TrainHitsAnotherTrainFrame_15>::size;
	using std::vector<TrainHitsAnotherTrainFrame_15>::begin;
	using std::vector<TrainHitsAnotherTrainFrame_15>::end;
	...
	{
		PB_TrainHitsAnotherTrainFrame_15Vector pbFrameVector;
...
#endif /*  VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_15_H_ */
