#ifndef VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_96_H_
#define VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_96_H_
...
class TrainHitsAnotherTrainFrame_96Vector;

struct TrainHitsAnotherTrainFrame_96 {
	
	using PBFrame = PB_TrainHitsAnotherTrainFrame_96;
	using FrameVector = TrainHitsAnotherTrainFrame_96Vector;
	...
	{
		PB_TrainHitsAnotherTrainFrame_96 pbframe;
...
class TrainHitsAnotherTrainFrame_96Vector 
	: private std::vector<TrainHitsAnotherTrainFrame_96>
{
	public:
	using std::vector<TrainHitsAnotherTrainFrame_96>::push_back;
	using std::vector<TrainHitsAnotherTrainFrame_96>::clear;
	using std::vector<TrainHitsAnotherTrainFrame_96>::empty;
	using std::vector<TrainHitsAnotherTrainFrame_96>::size;
	using std::vector<TrainHitsAnotherTrainFrame_96>::begin;
	using std::vector<TrainHitsAnotherTrainFrame_96>::end;
	...
	{
		PB_TrainHitsAnotherTrainFrame_96Vector pbFrameVector;
...
#endif /*  VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_96_H_ */
