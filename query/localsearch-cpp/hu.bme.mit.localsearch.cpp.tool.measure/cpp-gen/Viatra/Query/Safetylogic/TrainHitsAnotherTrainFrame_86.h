#ifndef VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_86_H_
#define VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_86_H_
...
class TrainHitsAnotherTrainFrame_86Vector;

struct TrainHitsAnotherTrainFrame_86 {
	
	using PBFrame = PB_TrainHitsAnotherTrainFrame_86;
	using FrameVector = TrainHitsAnotherTrainFrame_86Vector;
	...
	{
		PB_TrainHitsAnotherTrainFrame_86 pbframe;
...
class TrainHitsAnotherTrainFrame_86Vector 
	: private std::vector<TrainHitsAnotherTrainFrame_86>
{
	public:
	using std::vector<TrainHitsAnotherTrainFrame_86>::push_back;
	using std::vector<TrainHitsAnotherTrainFrame_86>::clear;
	using std::vector<TrainHitsAnotherTrainFrame_86>::empty;
	using std::vector<TrainHitsAnotherTrainFrame_86>::size;
	using std::vector<TrainHitsAnotherTrainFrame_86>::begin;
	using std::vector<TrainHitsAnotherTrainFrame_86>::end;
	...
	{
		PB_TrainHitsAnotherTrainFrame_86Vector pbFrameVector;
...
#endif /*  VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_86_H_ */
