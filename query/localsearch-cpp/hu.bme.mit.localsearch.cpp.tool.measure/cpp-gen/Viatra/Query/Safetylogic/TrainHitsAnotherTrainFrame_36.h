#ifndef VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_36_H_
#define VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_36_H_
...
class TrainHitsAnotherTrainFrame_36Vector;

struct TrainHitsAnotherTrainFrame_36 {
	
	using PBFrame = PB_TrainHitsAnotherTrainFrame_36;
	using FrameVector = TrainHitsAnotherTrainFrame_36Vector;
	...
	{
		PB_TrainHitsAnotherTrainFrame_36 pbframe;
...
class TrainHitsAnotherTrainFrame_36Vector 
	: private std::vector<TrainHitsAnotherTrainFrame_36>
{
	public:
	using std::vector<TrainHitsAnotherTrainFrame_36>::push_back;
	using std::vector<TrainHitsAnotherTrainFrame_36>::clear;
	using std::vector<TrainHitsAnotherTrainFrame_36>::empty;
	using std::vector<TrainHitsAnotherTrainFrame_36>::size;
	using std::vector<TrainHitsAnotherTrainFrame_36>::begin;
	using std::vector<TrainHitsAnotherTrainFrame_36>::end;
	...
	{
		PB_TrainHitsAnotherTrainFrame_36Vector pbFrameVector;
...
#endif /*  VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_36_H_ */
