#ifndef VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_NEXT_AFTER_NEXT_FRAME_27_H_
#define VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_NEXT_AFTER_NEXT_FRAME_27_H_
...
class TrainHitsAnotherTrainNextAfterNextFrame_27Vector;

struct TrainHitsAnotherTrainNextAfterNextFrame_27 {
	
	using PBFrame = PB_TrainHitsAnotherTrainNextAfterNextFrame_27;
	using FrameVector = TrainHitsAnotherTrainNextAfterNextFrame_27Vector;
	...
	std::string toString() const
	{
		...
		ret += ",nextSection<1>_viablePaths<0>_straight=";
	...
	{
		PB_TrainHitsAnotherTrainNextAfterNextFrame_27 pbframe;
	...
	void ParseFromString(std::string str, ModelRoot *mr)
	{
		...
		_10 = (pbframe._10() == -1) 
			? nullptr 
			: dynamic_cast<::railRoadModel::IPath*>(mr->findModelElementByID(pbframe._10()));
		...
		_13 = (pbframe._13() == -1) 
			? nullptr 
			: dynamic_cast<::railRoadModel::ITurnout*>(mr->findModelElementByID(pbframe._13()));
		
	}
};
		
class TrainHitsAnotherTrainNextAfterNextFrame_27Vector 
	: private std::vector<TrainHitsAnotherTrainNextAfterNextFrame_27>
{
	public:
	using std::vector<TrainHitsAnotherTrainNextAfterNextFrame_27>::push_back;
	using std::vector<TrainHitsAnotherTrainNextAfterNextFrame_27>::clear;
	using std::vector<TrainHitsAnotherTrainNextAfterNextFrame_27>::empty;
	using std::vector<TrainHitsAnotherTrainNextAfterNextFrame_27>::size;
	using std::vector<TrainHitsAnotherTrainNextAfterNextFrame_27>::begin;
	using std::vector<TrainHitsAnotherTrainNextAfterNextFrame_27>::end;
	...
	{
		PB_TrainHitsAnotherTrainNextAfterNextFrame_27Vector pbFrameVector;
...
#endif /*  VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_NEXT_AFTER_NEXT_FRAME_27_H_ */
