#ifndef VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_50_H_
#define VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_50_H_
...
class TrainHitsAnotherTrainFrame_50Vector;

struct TrainHitsAnotherTrainFrame_50 {
	
	using PBFrame = PB_TrainHitsAnotherTrainFrame_50;
	using FrameVector = TrainHitsAnotherTrainFrame_50Vector;
	...
	{
		PB_TrainHitsAnotherTrainFrame_50 pbframe;
...
class TrainHitsAnotherTrainFrame_50Vector 
	: private std::vector<TrainHitsAnotherTrainFrame_50>
{
	public:
	using std::vector<TrainHitsAnotherTrainFrame_50>::push_back;
	using std::vector<TrainHitsAnotherTrainFrame_50>::clear;
	using std::vector<TrainHitsAnotherTrainFrame_50>::empty;
	using std::vector<TrainHitsAnotherTrainFrame_50>::size;
	using std::vector<TrainHitsAnotherTrainFrame_50>::begin;
	using std::vector<TrainHitsAnotherTrainFrame_50>::end;
	...
	{
		PB_TrainHitsAnotherTrainFrame_50Vector pbFrameVector;
...
#endif /*  VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_50_H_ */
