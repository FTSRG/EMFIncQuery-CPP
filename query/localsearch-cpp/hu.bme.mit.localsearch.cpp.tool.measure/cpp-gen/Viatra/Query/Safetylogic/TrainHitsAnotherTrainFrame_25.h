#ifndef VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_25_H_
#define VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_25_H_
...
class TrainHitsAnotherTrainFrame_25Vector;

struct TrainHitsAnotherTrainFrame_25 {
	
	using PBFrame = PB_TrainHitsAnotherTrainFrame_25;
	using FrameVector = TrainHitsAnotherTrainFrame_25Vector;
	...
	{
		PB_TrainHitsAnotherTrainFrame_25 pbframe;
...
class TrainHitsAnotherTrainFrame_25Vector 
	: private std::vector<TrainHitsAnotherTrainFrame_25>
{
	public:
	using std::vector<TrainHitsAnotherTrainFrame_25>::push_back;
	using std::vector<TrainHitsAnotherTrainFrame_25>::clear;
	using std::vector<TrainHitsAnotherTrainFrame_25>::empty;
	using std::vector<TrainHitsAnotherTrainFrame_25>::size;
	using std::vector<TrainHitsAnotherTrainFrame_25>::begin;
	using std::vector<TrainHitsAnotherTrainFrame_25>::end;
	...
	{
		PB_TrainHitsAnotherTrainFrame_25Vector pbFrameVector;
...
#endif /*  VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_25_H_ */
