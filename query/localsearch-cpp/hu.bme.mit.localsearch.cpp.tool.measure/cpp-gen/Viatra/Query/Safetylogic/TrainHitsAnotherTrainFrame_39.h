#ifndef VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_39_H_
#define VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_39_H_
...
class TrainHitsAnotherTrainFrame_39Vector;

struct TrainHitsAnotherTrainFrame_39 {
	
	using PBFrame = PB_TrainHitsAnotherTrainFrame_39;
	using FrameVector = TrainHitsAnotherTrainFrame_39Vector;
	...
	{
		PB_TrainHitsAnotherTrainFrame_39 pbframe;
...
class TrainHitsAnotherTrainFrame_39Vector 
	: private std::vector<TrainHitsAnotherTrainFrame_39>
{
	public:
	using std::vector<TrainHitsAnotherTrainFrame_39>::push_back;
	using std::vector<TrainHitsAnotherTrainFrame_39>::clear;
	using std::vector<TrainHitsAnotherTrainFrame_39>::empty;
	using std::vector<TrainHitsAnotherTrainFrame_39>::size;
	using std::vector<TrainHitsAnotherTrainFrame_39>::begin;
	using std::vector<TrainHitsAnotherTrainFrame_39>::end;
	...
	{
		PB_TrainHitsAnotherTrainFrame_39Vector pbFrameVector;
...
#endif /*  VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_39_H_ */
