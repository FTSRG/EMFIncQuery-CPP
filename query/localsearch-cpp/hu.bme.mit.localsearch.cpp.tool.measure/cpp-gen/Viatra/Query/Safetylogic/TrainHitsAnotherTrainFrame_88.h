#ifndef VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_88_H_
#define VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_88_H_
...
class TrainHitsAnotherTrainFrame_88Vector;

struct TrainHitsAnotherTrainFrame_88 {
	
	using PBFrame = PB_TrainHitsAnotherTrainFrame_88;
	using FrameVector = TrainHitsAnotherTrainFrame_88Vector;
	...
	{
		PB_TrainHitsAnotherTrainFrame_88 pbframe;
...
class TrainHitsAnotherTrainFrame_88Vector 
	: private std::vector<TrainHitsAnotherTrainFrame_88>
{
	public:
	using std::vector<TrainHitsAnotherTrainFrame_88>::push_back;
	using std::vector<TrainHitsAnotherTrainFrame_88>::clear;
	using std::vector<TrainHitsAnotherTrainFrame_88>::empty;
	using std::vector<TrainHitsAnotherTrainFrame_88>::size;
	using std::vector<TrainHitsAnotherTrainFrame_88>::begin;
	using std::vector<TrainHitsAnotherTrainFrame_88>::end;
	...
	{
		PB_TrainHitsAnotherTrainFrame_88Vector pbFrameVector;
...
#endif /*  VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_88_H_ */
