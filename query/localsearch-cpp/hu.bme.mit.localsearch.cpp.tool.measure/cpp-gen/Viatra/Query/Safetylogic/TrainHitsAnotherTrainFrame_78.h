#ifndef VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_78_H_
#define VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_78_H_
...
class TrainHitsAnotherTrainFrame_78Vector;

struct TrainHitsAnotherTrainFrame_78 {
	
	using PBFrame = PB_TrainHitsAnotherTrainFrame_78;
	using FrameVector = TrainHitsAnotherTrainFrame_78Vector;
	...
	{
		PB_TrainHitsAnotherTrainFrame_78 pbframe;
...
class TrainHitsAnotherTrainFrame_78Vector 
	: private std::vector<TrainHitsAnotherTrainFrame_78>
{
	public:
	using std::vector<TrainHitsAnotherTrainFrame_78>::push_back;
	using std::vector<TrainHitsAnotherTrainFrame_78>::clear;
	using std::vector<TrainHitsAnotherTrainFrame_78>::empty;
	using std::vector<TrainHitsAnotherTrainFrame_78>::size;
	using std::vector<TrainHitsAnotherTrainFrame_78>::begin;
	using std::vector<TrainHitsAnotherTrainFrame_78>::end;
	...
	{
		PB_TrainHitsAnotherTrainFrame_78Vector pbFrameVector;
...
#endif /*  VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_78_H_ */
