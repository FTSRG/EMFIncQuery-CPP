#ifndef VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_17_H_
#define VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_17_H_
...
class TrainHitsAnotherTrainFrame_17Vector;

struct TrainHitsAnotherTrainFrame_17 {
	
	using PBFrame = PB_TrainHitsAnotherTrainFrame_17;
	using FrameVector = TrainHitsAnotherTrainFrame_17Vector;
	...
	{
		PB_TrainHitsAnotherTrainFrame_17 pbframe;
...
class TrainHitsAnotherTrainFrame_17Vector 
	: private std::vector<TrainHitsAnotherTrainFrame_17>
{
	public:
	using std::vector<TrainHitsAnotherTrainFrame_17>::push_back;
	using std::vector<TrainHitsAnotherTrainFrame_17>::clear;
	using std::vector<TrainHitsAnotherTrainFrame_17>::empty;
	using std::vector<TrainHitsAnotherTrainFrame_17>::size;
	using std::vector<TrainHitsAnotherTrainFrame_17>::begin;
	using std::vector<TrainHitsAnotherTrainFrame_17>::end;
	...
	{
		PB_TrainHitsAnotherTrainFrame_17Vector pbFrameVector;
...
#endif /*  VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_17_H_ */
