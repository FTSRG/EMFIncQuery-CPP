#ifndef VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_90_H_
#define VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_90_H_
...
class TrainHitsAnotherTrainFrame_90Vector;

struct TrainHitsAnotherTrainFrame_90 {
	
	using PBFrame = PB_TrainHitsAnotherTrainFrame_90;
	using FrameVector = TrainHitsAnotherTrainFrame_90Vector;
	...
	{
		PB_TrainHitsAnotherTrainFrame_90 pbframe;
...
class TrainHitsAnotherTrainFrame_90Vector 
	: private std::vector<TrainHitsAnotherTrainFrame_90>
{
	public:
	using std::vector<TrainHitsAnotherTrainFrame_90>::push_back;
	using std::vector<TrainHitsAnotherTrainFrame_90>::clear;
	using std::vector<TrainHitsAnotherTrainFrame_90>::empty;
	using std::vector<TrainHitsAnotherTrainFrame_90>::size;
	using std::vector<TrainHitsAnotherTrainFrame_90>::begin;
	using std::vector<TrainHitsAnotherTrainFrame_90>::end;
	...
	{
		PB_TrainHitsAnotherTrainFrame_90Vector pbFrameVector;
...
#endif /*  VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_90_H_ */
