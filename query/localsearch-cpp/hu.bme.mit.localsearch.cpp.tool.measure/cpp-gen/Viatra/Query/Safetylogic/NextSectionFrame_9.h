#ifndef VIATRA__QUERY__SAFETYLOGIC__NEXT_SECTION_FRAME_9_H_
#define VIATRA__QUERY__SAFETYLOGIC__NEXT_SECTION_FRAME_9_H_
...
class NextSectionFrame_9Vector;

struct NextSectionFrame_9 {
	
	using PBFrame = PB_NextSectionFrame_9;
	using FrameVector = NextSectionFrame_9Vector;
...
class NextSectionFrame_9Vector 
	: private std::vector<NextSectionFrame_9>
{
	public:
	using std::vector<NextSectionFrame_9>::push_back;
	using std::vector<NextSectionFrame_9>::clear;
	using std::vector<NextSectionFrame_9>::empty;
	using std::vector<NextSectionFrame_9>::size;
	using std::vector<NextSectionFrame_9>::begin;
	using std::vector<NextSectionFrame_9>::end;
	...
	{
		PB_NextSectionFrame_9Vector pbFrameVector;
...
#endif /*  VIATRA__QUERY__SAFETYLOGIC__NEXT_SECTION_FRAME_9_H_ */
