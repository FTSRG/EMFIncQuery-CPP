#ifndef VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_52_H_
#define VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_52_H_
...
class TrainHitsAnotherTrainFrame_52Vector;

struct TrainHitsAnotherTrainFrame_52 {
	
	using PBFrame = PB_TrainHitsAnotherTrainFrame_52;
	using FrameVector = TrainHitsAnotherTrainFrame_52Vector;
	...
	{
		PB_TrainHitsAnotherTrainFrame_52 pbframe;
...
class TrainHitsAnotherTrainFrame_52Vector 
	: private std::vector<TrainHitsAnotherTrainFrame_52>
{
	public:
	using std::vector<TrainHitsAnotherTrainFrame_52>::push_back;
	using std::vector<TrainHitsAnotherTrainFrame_52>::clear;
	using std::vector<TrainHitsAnotherTrainFrame_52>::empty;
	using std::vector<TrainHitsAnotherTrainFrame_52>::size;
	using std::vector<TrainHitsAnotherTrainFrame_52>::begin;
	using std::vector<TrainHitsAnotherTrainFrame_52>::end;
	...
	{
		PB_TrainHitsAnotherTrainFrame_52Vector pbFrameVector;
...
#endif /*  VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_52_H_ */
