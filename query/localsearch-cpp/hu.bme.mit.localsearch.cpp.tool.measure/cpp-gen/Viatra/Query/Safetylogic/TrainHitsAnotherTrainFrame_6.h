#ifndef VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_6_H_
#define VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_6_H_
...
class TrainHitsAnotherTrainFrame_6Vector;

struct TrainHitsAnotherTrainFrame_6 {
	
	using PBFrame = PB_TrainHitsAnotherTrainFrame_6;
	using FrameVector = TrainHitsAnotherTrainFrame_6Vector;
	...
	{
		PB_TrainHitsAnotherTrainFrame_6 pbframe;
...
class TrainHitsAnotherTrainFrame_6Vector 
	: private std::vector<TrainHitsAnotherTrainFrame_6>
{
	public:
	using std::vector<TrainHitsAnotherTrainFrame_6>::push_back;
	using std::vector<TrainHitsAnotherTrainFrame_6>::clear;
	using std::vector<TrainHitsAnotherTrainFrame_6>::empty;
	using std::vector<TrainHitsAnotherTrainFrame_6>::size;
	using std::vector<TrainHitsAnotherTrainFrame_6>::begin;
	using std::vector<TrainHitsAnotherTrainFrame_6>::end;
	...
	{
		PB_TrainHitsAnotherTrainFrame_6Vector pbFrameVector;
...
#endif /*  VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_6_H_ */
