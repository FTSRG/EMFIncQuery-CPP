#ifndef VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_4_H_
#define VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_4_H_
...
class TrainHitsAnotherTrainFrame_4Vector;

struct TrainHitsAnotherTrainFrame_4 {
	
	using PBFrame = PB_TrainHitsAnotherTrainFrame_4;
	using FrameVector = TrainHitsAnotherTrainFrame_4Vector;
	...
	{
		PB_TrainHitsAnotherTrainFrame_4 pbframe;
...
class TrainHitsAnotherTrainFrame_4Vector 
	: private std::vector<TrainHitsAnotherTrainFrame_4>
{
	public:
	using std::vector<TrainHitsAnotherTrainFrame_4>::push_back;
	using std::vector<TrainHitsAnotherTrainFrame_4>::clear;
	using std::vector<TrainHitsAnotherTrainFrame_4>::empty;
	using std::vector<TrainHitsAnotherTrainFrame_4>::size;
	using std::vector<TrainHitsAnotherTrainFrame_4>::begin;
	using std::vector<TrainHitsAnotherTrainFrame_4>::end;
	...
	{
		PB_TrainHitsAnotherTrainFrame_4Vector pbFrameVector;
...
#endif /*  VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_4_H_ */
