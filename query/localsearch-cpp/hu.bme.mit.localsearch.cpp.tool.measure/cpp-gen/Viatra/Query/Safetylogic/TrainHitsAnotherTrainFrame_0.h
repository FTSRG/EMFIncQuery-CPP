#ifndef VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_0_H_
#define VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_0_H_
...
class TrainHitsAnotherTrainFrame_0Vector;

struct TrainHitsAnotherTrainFrame_0 {
	
	using PBFrame = PB_TrainHitsAnotherTrainFrame_0;
	using FrameVector = TrainHitsAnotherTrainFrame_0Vector;
	...
	{
		PB_TrainHitsAnotherTrainFrame_0 pbframe;
...
class TrainHitsAnotherTrainFrame_0Vector 
	: private std::vector<TrainHitsAnotherTrainFrame_0>
{
	public:
	using std::vector<TrainHitsAnotherTrainFrame_0>::push_back;
	using std::vector<TrainHitsAnotherTrainFrame_0>::clear;
	using std::vector<TrainHitsAnotherTrainFrame_0>::empty;
	using std::vector<TrainHitsAnotherTrainFrame_0>::size;
	using std::vector<TrainHitsAnotherTrainFrame_0>::begin;
	using std::vector<TrainHitsAnotherTrainFrame_0>::end;
	...
	{
		PB_TrainHitsAnotherTrainFrame_0Vector pbFrameVector;
...
#endif /*  VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_0_H_ */
