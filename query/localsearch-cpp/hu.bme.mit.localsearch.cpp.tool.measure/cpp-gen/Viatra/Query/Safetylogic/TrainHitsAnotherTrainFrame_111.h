#ifndef VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_111_H_
#define VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_111_H_
...
class TrainHitsAnotherTrainFrame_111Vector;

struct TrainHitsAnotherTrainFrame_111 {
	
	using PBFrame = PB_TrainHitsAnotherTrainFrame_111;
	using FrameVector = TrainHitsAnotherTrainFrame_111Vector;
	...
	{
		PB_TrainHitsAnotherTrainFrame_111 pbframe;
...
class TrainHitsAnotherTrainFrame_111Vector 
	: private std::vector<TrainHitsAnotherTrainFrame_111>
{
	public:
	using std::vector<TrainHitsAnotherTrainFrame_111>::push_back;
	using std::vector<TrainHitsAnotherTrainFrame_111>::clear;
	using std::vector<TrainHitsAnotherTrainFrame_111>::empty;
	using std::vector<TrainHitsAnotherTrainFrame_111>::size;
	using std::vector<TrainHitsAnotherTrainFrame_111>::begin;
	using std::vector<TrainHitsAnotherTrainFrame_111>::end;
	...
	{
		PB_TrainHitsAnotherTrainFrame_111Vector pbFrameVector;
...
#endif /*  VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_111_H_ */
