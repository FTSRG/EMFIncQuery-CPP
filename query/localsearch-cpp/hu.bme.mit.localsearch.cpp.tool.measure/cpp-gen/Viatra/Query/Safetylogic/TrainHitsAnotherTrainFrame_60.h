#ifndef VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_60_H_
#define VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_60_H_
...
class TrainHitsAnotherTrainFrame_60Vector;

struct TrainHitsAnotherTrainFrame_60 {
	
	using PBFrame = PB_TrainHitsAnotherTrainFrame_60;
	using FrameVector = TrainHitsAnotherTrainFrame_60Vector;
	...
	{
		PB_TrainHitsAnotherTrainFrame_60 pbframe;
...
class TrainHitsAnotherTrainFrame_60Vector 
	: private std::vector<TrainHitsAnotherTrainFrame_60>
{
	public:
	using std::vector<TrainHitsAnotherTrainFrame_60>::push_back;
	using std::vector<TrainHitsAnotherTrainFrame_60>::clear;
	using std::vector<TrainHitsAnotherTrainFrame_60>::empty;
	using std::vector<TrainHitsAnotherTrainFrame_60>::size;
	using std::vector<TrainHitsAnotherTrainFrame_60>::begin;
	using std::vector<TrainHitsAnotherTrainFrame_60>::end;
	...
	{
		PB_TrainHitsAnotherTrainFrame_60Vector pbFrameVector;
...
#endif /*  VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_60_H_ */
