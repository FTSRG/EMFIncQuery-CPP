#ifndef VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_9_H_
#define VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_9_H_
...
class TrainHitsAnotherTrainFrame_9Vector;

struct TrainHitsAnotherTrainFrame_9 {
	
	using PBFrame = PB_TrainHitsAnotherTrainFrame_9;
	using FrameVector = TrainHitsAnotherTrainFrame_9Vector;
	...
	{
		PB_TrainHitsAnotherTrainFrame_9 pbframe;
...
class TrainHitsAnotherTrainFrame_9Vector 
	: private std::vector<TrainHitsAnotherTrainFrame_9>
{
	public:
	using std::vector<TrainHitsAnotherTrainFrame_9>::push_back;
	using std::vector<TrainHitsAnotherTrainFrame_9>::clear;
	using std::vector<TrainHitsAnotherTrainFrame_9>::empty;
	using std::vector<TrainHitsAnotherTrainFrame_9>::size;
	using std::vector<TrainHitsAnotherTrainFrame_9>::begin;
	using std::vector<TrainHitsAnotherTrainFrame_9>::end;
	...
	{
		PB_TrainHitsAnotherTrainFrame_9Vector pbFrameVector;
...
#endif /*  VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_9_H_ */
