#ifndef VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_114_H_
#define VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_114_H_
...
class TrainHitsAnotherTrainFrame_114Vector;

struct TrainHitsAnotherTrainFrame_114 {
	
	using PBFrame = PB_TrainHitsAnotherTrainFrame_114;
	using FrameVector = TrainHitsAnotherTrainFrame_114Vector;
	...
	{
		PB_TrainHitsAnotherTrainFrame_114 pbframe;
...
class TrainHitsAnotherTrainFrame_114Vector 
	: private std::vector<TrainHitsAnotherTrainFrame_114>
{
	public:
	using std::vector<TrainHitsAnotherTrainFrame_114>::push_back;
	using std::vector<TrainHitsAnotherTrainFrame_114>::clear;
	using std::vector<TrainHitsAnotherTrainFrame_114>::empty;
	using std::vector<TrainHitsAnotherTrainFrame_114>::size;
	using std::vector<TrainHitsAnotherTrainFrame_114>::begin;
	using std::vector<TrainHitsAnotherTrainFrame_114>::end;
	...
	{
		PB_TrainHitsAnotherTrainFrame_114Vector pbFrameVector;
...
#endif /*  VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_114_H_ */
