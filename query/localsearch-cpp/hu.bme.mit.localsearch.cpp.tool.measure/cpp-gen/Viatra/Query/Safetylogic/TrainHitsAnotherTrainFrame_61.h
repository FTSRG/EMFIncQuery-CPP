#ifndef VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_61_H_
#define VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_61_H_
...
class TrainHitsAnotherTrainFrame_61Vector;

struct TrainHitsAnotherTrainFrame_61 {
	
	using PBFrame = PB_TrainHitsAnotherTrainFrame_61;
	using FrameVector = TrainHitsAnotherTrainFrame_61Vector;
	...
	{
		PB_TrainHitsAnotherTrainFrame_61 pbframe;
...
class TrainHitsAnotherTrainFrame_61Vector 
	: private std::vector<TrainHitsAnotherTrainFrame_61>
{
	public:
	using std::vector<TrainHitsAnotherTrainFrame_61>::push_back;
	using std::vector<TrainHitsAnotherTrainFrame_61>::clear;
	using std::vector<TrainHitsAnotherTrainFrame_61>::empty;
	using std::vector<TrainHitsAnotherTrainFrame_61>::size;
	using std::vector<TrainHitsAnotherTrainFrame_61>::begin;
	using std::vector<TrainHitsAnotherTrainFrame_61>::end;
	...
	{
		PB_TrainHitsAnotherTrainFrame_61Vector pbFrameVector;
...
#endif /*  VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_61_H_ */
