#ifndef VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_51_H_
#define VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_51_H_
...
class TrainHitsAnotherTrainFrame_51Vector;

struct TrainHitsAnotherTrainFrame_51 {
	
	using PBFrame = PB_TrainHitsAnotherTrainFrame_51;
	using FrameVector = TrainHitsAnotherTrainFrame_51Vector;
	...
	{
		PB_TrainHitsAnotherTrainFrame_51 pbframe;
...
class TrainHitsAnotherTrainFrame_51Vector 
	: private std::vector<TrainHitsAnotherTrainFrame_51>
{
	public:
	using std::vector<TrainHitsAnotherTrainFrame_51>::push_back;
	using std::vector<TrainHitsAnotherTrainFrame_51>::clear;
	using std::vector<TrainHitsAnotherTrainFrame_51>::empty;
	using std::vector<TrainHitsAnotherTrainFrame_51>::size;
	using std::vector<TrainHitsAnotherTrainFrame_51>::begin;
	using std::vector<TrainHitsAnotherTrainFrame_51>::end;
	...
	{
		PB_TrainHitsAnotherTrainFrame_51Vector pbFrameVector;
...
#endif /*  VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_51_H_ */
