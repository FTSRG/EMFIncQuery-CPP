#ifndef VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_NEXT_AFTER_NEXT_FRAME_59_H_
#define VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_NEXT_AFTER_NEXT_FRAME_59_H_
...
class TrainHitsAnotherTrainNextAfterNextFrame_59Vector;

struct TrainHitsAnotherTrainNextAfterNextFrame_59 {
	
	using PBFrame = PB_TrainHitsAnotherTrainNextAfterNextFrame_59;
	using FrameVector = TrainHitsAnotherTrainNextAfterNextFrame_59Vector;
	...
	::railRoadModel::ISegment* _7 = nullptr;
	...
	{
		PB_TrainHitsAnotherTrainNextAfterNextFrame_59 pbframe;
	...
	void ParseFromString(std::string str, ModelRoot *mr)
	{
		...
		_7 = (pbframe._7() == -1) 
			? nullptr 
			: dynamic_cast<::railRoadModel::ISegment*>(mr->findModelElementByID(pbframe._7()));
...
class TrainHitsAnotherTrainNextAfterNextFrame_59Vector 
	: private std::vector<TrainHitsAnotherTrainNextAfterNextFrame_59>
{
	public:
	using std::vector<TrainHitsAnotherTrainNextAfterNextFrame_59>::push_back;
	using std::vector<TrainHitsAnotherTrainNextAfterNextFrame_59>::clear;
	using std::vector<TrainHitsAnotherTrainNextAfterNextFrame_59>::empty;
	using std::vector<TrainHitsAnotherTrainNextAfterNextFrame_59>::size;
	using std::vector<TrainHitsAnotherTrainNextAfterNextFrame_59>::begin;
	using std::vector<TrainHitsAnotherTrainNextAfterNextFrame_59>::end;
	...
	{
		PB_TrainHitsAnotherTrainNextAfterNextFrame_59Vector pbFrameVector;
...
#endif /*  VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_NEXT_AFTER_NEXT_FRAME_59_H_ */
