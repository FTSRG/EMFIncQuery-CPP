#ifndef VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_2_H_
#define VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_2_H_
...
class TrainHitsAnotherTrainFrame_2Vector;

struct TrainHitsAnotherTrainFrame_2 {
	
	using PBFrame = PB_TrainHitsAnotherTrainFrame_2;
	using FrameVector = TrainHitsAnotherTrainFrame_2Vector;
	...
	{
		PB_TrainHitsAnotherTrainFrame_2 pbframe;
...
class TrainHitsAnotherTrainFrame_2Vector 
	: private std::vector<TrainHitsAnotherTrainFrame_2>
{
	public:
	using std::vector<TrainHitsAnotherTrainFrame_2>::push_back;
	using std::vector<TrainHitsAnotherTrainFrame_2>::clear;
	using std::vector<TrainHitsAnotherTrainFrame_2>::empty;
	using std::vector<TrainHitsAnotherTrainFrame_2>::size;
	using std::vector<TrainHitsAnotherTrainFrame_2>::begin;
	using std::vector<TrainHitsAnotherTrainFrame_2>::end;
	...
	{
		PB_TrainHitsAnotherTrainFrame_2Vector pbFrameVector;
...
#endif /*  VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_2_H_ */
