#ifndef VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_NEXT_AFTER_NEXT_FRAME_93_H_
#define VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_NEXT_AFTER_NEXT_FRAME_93_H_
...
class TrainHitsAnotherTrainNextAfterNextFrame_93Vector;

struct TrainHitsAnotherTrainNextAfterNextFrame_93 {
	
	using PBFrame = PB_TrainHitsAnotherTrainNextAfterNextFrame_93;
	using FrameVector = TrainHitsAnotherTrainNextAfterNextFrame_93Vector;
	...
	::railRoadModel::ISegment* _13 = nullptr;
	// toString
	...
	{
		PB_TrainHitsAnotherTrainNextAfterNextFrame_93 pbframe;
	...
	void ParseFromString(std::string str, ModelRoot *mr)
	{
		...
		_13 = (pbframe._13() == -1) 
			? nullptr 
			: dynamic_cast<::railRoadModel::ISegment*>(mr->findModelElementByID(pbframe._13()));
		
	}
};
		
class TrainHitsAnotherTrainNextAfterNextFrame_93Vector 
	: private std::vector<TrainHitsAnotherTrainNextAfterNextFrame_93>
{
	public:
	using std::vector<TrainHitsAnotherTrainNextAfterNextFrame_93>::push_back;
	using std::vector<TrainHitsAnotherTrainNextAfterNextFrame_93>::clear;
	using std::vector<TrainHitsAnotherTrainNextAfterNextFrame_93>::empty;
	using std::vector<TrainHitsAnotherTrainNextAfterNextFrame_93>::size;
	using std::vector<TrainHitsAnotherTrainNextAfterNextFrame_93>::begin;
	using std::vector<TrainHitsAnotherTrainNextAfterNextFrame_93>::end;
	...
	{
		PB_TrainHitsAnotherTrainNextAfterNextFrame_93Vector pbFrameVector;
...
#endif /*  VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_NEXT_AFTER_NEXT_FRAME_93_H_ */
