#ifndef VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_43_H_
#define VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_43_H_
...
class TrainHitsAnotherTrainFrame_43Vector;

struct TrainHitsAnotherTrainFrame_43 {
	
	using PBFrame = PB_TrainHitsAnotherTrainFrame_43;
	using FrameVector = TrainHitsAnotherTrainFrame_43Vector;
	...
	{
		PB_TrainHitsAnotherTrainFrame_43 pbframe;
...
class TrainHitsAnotherTrainFrame_43Vector 
	: private std::vector<TrainHitsAnotherTrainFrame_43>
{
	public:
	using std::vector<TrainHitsAnotherTrainFrame_43>::push_back;
	using std::vector<TrainHitsAnotherTrainFrame_43>::clear;
	using std::vector<TrainHitsAnotherTrainFrame_43>::empty;
	using std::vector<TrainHitsAnotherTrainFrame_43>::size;
	using std::vector<TrainHitsAnotherTrainFrame_43>::begin;
	using std::vector<TrainHitsAnotherTrainFrame_43>::end;
	...
	{
		PB_TrainHitsAnotherTrainFrame_43Vector pbFrameVector;
...
#endif /*  VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_43_H_ */
