#ifndef VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_92_H_
#define VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_92_H_
...
class TrainHitsAnotherTrainFrame_92Vector;

struct TrainHitsAnotherTrainFrame_92 {
	
	using PBFrame = PB_TrainHitsAnotherTrainFrame_92;
	using FrameVector = TrainHitsAnotherTrainFrame_92Vector;
	...
	{
		PB_TrainHitsAnotherTrainFrame_92 pbframe;
...
class TrainHitsAnotherTrainFrame_92Vector 
	: private std::vector<TrainHitsAnotherTrainFrame_92>
{
	public:
	using std::vector<TrainHitsAnotherTrainFrame_92>::push_back;
	using std::vector<TrainHitsAnotherTrainFrame_92>::clear;
	using std::vector<TrainHitsAnotherTrainFrame_92>::empty;
	using std::vector<TrainHitsAnotherTrainFrame_92>::size;
	using std::vector<TrainHitsAnotherTrainFrame_92>::begin;
	using std::vector<TrainHitsAnotherTrainFrame_92>::end;
	...
	{
		PB_TrainHitsAnotherTrainFrame_92Vector pbFrameVector;
...
#endif /*  VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_92_H_ */
