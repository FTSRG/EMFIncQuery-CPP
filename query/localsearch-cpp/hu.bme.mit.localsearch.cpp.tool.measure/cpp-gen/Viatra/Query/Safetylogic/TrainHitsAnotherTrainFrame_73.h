#ifndef VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_73_H_
#define VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_73_H_
...
class TrainHitsAnotherTrainFrame_73Vector;

struct TrainHitsAnotherTrainFrame_73 {
	
	using PBFrame = PB_TrainHitsAnotherTrainFrame_73;
	using FrameVector = TrainHitsAnotherTrainFrame_73Vector;
	...
	{
		PB_TrainHitsAnotherTrainFrame_73 pbframe;
...
class TrainHitsAnotherTrainFrame_73Vector 
	: private std::vector<TrainHitsAnotherTrainFrame_73>
{
	public:
	using std::vector<TrainHitsAnotherTrainFrame_73>::push_back;
	using std::vector<TrainHitsAnotherTrainFrame_73>::clear;
	using std::vector<TrainHitsAnotherTrainFrame_73>::empty;
	using std::vector<TrainHitsAnotherTrainFrame_73>::size;
	using std::vector<TrainHitsAnotherTrainFrame_73>::begin;
	using std::vector<TrainHitsAnotherTrainFrame_73>::end;
	...
	{
		PB_TrainHitsAnotherTrainFrame_73Vector pbFrameVector;
...
#endif /*  VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_73_H_ */
