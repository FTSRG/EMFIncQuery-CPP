#ifndef VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_49_H_
#define VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_49_H_
...
class TrainHitsAnotherTrainFrame_49Vector;

struct TrainHitsAnotherTrainFrame_49 {
	
	using PBFrame = PB_TrainHitsAnotherTrainFrame_49;
	using FrameVector = TrainHitsAnotherTrainFrame_49Vector;
	...
	{
		PB_TrainHitsAnotherTrainFrame_49 pbframe;
...
class TrainHitsAnotherTrainFrame_49Vector 
	: private std::vector<TrainHitsAnotherTrainFrame_49>
{
	public:
	using std::vector<TrainHitsAnotherTrainFrame_49>::push_back;
	using std::vector<TrainHitsAnotherTrainFrame_49>::clear;
	using std::vector<TrainHitsAnotherTrainFrame_49>::empty;
	using std::vector<TrainHitsAnotherTrainFrame_49>::size;
	using std::vector<TrainHitsAnotherTrainFrame_49>::begin;
	using std::vector<TrainHitsAnotherTrainFrame_49>::end;
	...
	{
		PB_TrainHitsAnotherTrainFrame_49Vector pbFrameVector;
...
#endif /*  VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_49_H_ */
