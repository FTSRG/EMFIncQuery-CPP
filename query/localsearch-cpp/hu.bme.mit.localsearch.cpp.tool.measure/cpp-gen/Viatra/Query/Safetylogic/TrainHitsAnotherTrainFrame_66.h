#ifndef VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_66_H_
#define VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_66_H_
...
class TrainHitsAnotherTrainFrame_66Vector;

struct TrainHitsAnotherTrainFrame_66 {
	
	using PBFrame = PB_TrainHitsAnotherTrainFrame_66;
	using FrameVector = TrainHitsAnotherTrainFrame_66Vector;
	...
	{
		PB_TrainHitsAnotherTrainFrame_66 pbframe;
...
class TrainHitsAnotherTrainFrame_66Vector 
	: private std::vector<TrainHitsAnotherTrainFrame_66>
{
	public:
	using std::vector<TrainHitsAnotherTrainFrame_66>::push_back;
	using std::vector<TrainHitsAnotherTrainFrame_66>::clear;
	using std::vector<TrainHitsAnotherTrainFrame_66>::empty;
	using std::vector<TrainHitsAnotherTrainFrame_66>::size;
	using std::vector<TrainHitsAnotherTrainFrame_66>::begin;
	using std::vector<TrainHitsAnotherTrainFrame_66>::end;
	...
	{
		PB_TrainHitsAnotherTrainFrame_66Vector pbFrameVector;
...
#endif /*  VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_66_H_ */
