#ifndef VIATRA__QUERY__SAFETYLOGIC__VIABLE_PATHS_FRAME_3_H_
#define VIATRA__QUERY__SAFETYLOGIC__VIABLE_PATHS_FRAME_3_H_
...
class ViablePathsFrame_3Vector;

struct ViablePathsFrame_3 {
	
	using PBFrame = PB_ViablePathsFrame_3;
	using FrameVector = ViablePathsFrame_3Vector;
...
class ViablePathsFrame_3Vector 
	: private std::vector<ViablePathsFrame_3>
{
	public:
	using std::vector<ViablePathsFrame_3>::push_back;
	using std::vector<ViablePathsFrame_3>::clear;
	using std::vector<ViablePathsFrame_3>::empty;
	using std::vector<ViablePathsFrame_3>::size;
	using std::vector<ViablePathsFrame_3>::begin;
	using std::vector<ViablePathsFrame_3>::end;
	...
	{
		PB_ViablePathsFrame_3Vector pbFrameVector;
...
#endif /*  VIATRA__QUERY__SAFETYLOGIC__VIABLE_PATHS_FRAME_3_H_ */
