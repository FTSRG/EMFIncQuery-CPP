#ifndef VIATRA__QUERY__SAFETYLOGIC__NEXT_SECTION_FRAME_6_H_
#define VIATRA__QUERY__SAFETYLOGIC__NEXT_SECTION_FRAME_6_H_
...
class NextSectionFrame_6Vector;

struct NextSectionFrame_6 {
	
	using PBFrame = PB_NextSectionFrame_6;
	using FrameVector = NextSectionFrame_6Vector;
...
class NextSectionFrame_6Vector 
	: private std::vector<NextSectionFrame_6>
{
	public:
	using std::vector<NextSectionFrame_6>::push_back;
	using std::vector<NextSectionFrame_6>::clear;
	using std::vector<NextSectionFrame_6>::empty;
	using std::vector<NextSectionFrame_6>::size;
	using std::vector<NextSectionFrame_6>::begin;
	using std::vector<NextSectionFrame_6>::end;
	...
	{
		PB_NextSectionFrame_6Vector pbFrameVector;
...
#endif /*  VIATRA__QUERY__SAFETYLOGIC__NEXT_SECTION_FRAME_6_H_ */
