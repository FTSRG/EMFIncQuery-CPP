#ifndef VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_110_H_
#define VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_110_H_
...
class TrainHitsAnotherTrainFrame_110Vector;

struct TrainHitsAnotherTrainFrame_110 {
	
	using PBFrame = PB_TrainHitsAnotherTrainFrame_110;
	using FrameVector = TrainHitsAnotherTrainFrame_110Vector;
	...
	{
		PB_TrainHitsAnotherTrainFrame_110 pbframe;
...
class TrainHitsAnotherTrainFrame_110Vector 
	: private std::vector<TrainHitsAnotherTrainFrame_110>
{
	public:
	using std::vector<TrainHitsAnotherTrainFrame_110>::push_back;
	using std::vector<TrainHitsAnotherTrainFrame_110>::clear;
	using std::vector<TrainHitsAnotherTrainFrame_110>::empty;
	using std::vector<TrainHitsAnotherTrainFrame_110>::size;
	using std::vector<TrainHitsAnotherTrainFrame_110>::begin;
	using std::vector<TrainHitsAnotherTrainFrame_110>::end;
	...
	{
		PB_TrainHitsAnotherTrainFrame_110Vector pbFrameVector;
...
#endif /*  VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_110_H_ */
