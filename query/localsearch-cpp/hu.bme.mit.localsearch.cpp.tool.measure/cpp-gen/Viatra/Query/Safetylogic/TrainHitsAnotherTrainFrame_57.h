#ifndef VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_57_H_
#define VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_57_H_
...
class TrainHitsAnotherTrainFrame_57Vector;

struct TrainHitsAnotherTrainFrame_57 {
	
	using PBFrame = PB_TrainHitsAnotherTrainFrame_57;
	using FrameVector = TrainHitsAnotherTrainFrame_57Vector;
	...
	{
		PB_TrainHitsAnotherTrainFrame_57 pbframe;
...
class TrainHitsAnotherTrainFrame_57Vector 
	: private std::vector<TrainHitsAnotherTrainFrame_57>
{
	public:
	using std::vector<TrainHitsAnotherTrainFrame_57>::push_back;
	using std::vector<TrainHitsAnotherTrainFrame_57>::clear;
	using std::vector<TrainHitsAnotherTrainFrame_57>::empty;
	using std::vector<TrainHitsAnotherTrainFrame_57>::size;
	using std::vector<TrainHitsAnotherTrainFrame_57>::begin;
	using std::vector<TrainHitsAnotherTrainFrame_57>::end;
	...
	{
		PB_TrainHitsAnotherTrainFrame_57Vector pbFrameVector;
...
#endif /*  VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_57_H_ */
