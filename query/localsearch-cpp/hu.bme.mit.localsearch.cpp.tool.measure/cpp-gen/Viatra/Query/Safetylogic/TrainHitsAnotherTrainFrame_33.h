#ifndef VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_33_H_
#define VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_33_H_
...
class TrainHitsAnotherTrainFrame_33Vector;

struct TrainHitsAnotherTrainFrame_33 {
	
	using PBFrame = PB_TrainHitsAnotherTrainFrame_33;
	using FrameVector = TrainHitsAnotherTrainFrame_33Vector;
	...
	{
		PB_TrainHitsAnotherTrainFrame_33 pbframe;
...
class TrainHitsAnotherTrainFrame_33Vector 
	: private std::vector<TrainHitsAnotherTrainFrame_33>
{
	public:
	using std::vector<TrainHitsAnotherTrainFrame_33>::push_back;
	using std::vector<TrainHitsAnotherTrainFrame_33>::clear;
	using std::vector<TrainHitsAnotherTrainFrame_33>::empty;
	using std::vector<TrainHitsAnotherTrainFrame_33>::size;
	using std::vector<TrainHitsAnotherTrainFrame_33>::begin;
	using std::vector<TrainHitsAnotherTrainFrame_33>::end;
	...
	{
		PB_TrainHitsAnotherTrainFrame_33Vector pbFrameVector;
...
#endif /*  VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_33_H_ */
