#ifndef VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_13_H_
#define VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_13_H_
...
class TrainHitsAnotherTrainFrame_13Vector;

struct TrainHitsAnotherTrainFrame_13 {
	
	using PBFrame = PB_TrainHitsAnotherTrainFrame_13;
	using FrameVector = TrainHitsAnotherTrainFrame_13Vector;
	...
	{
		PB_TrainHitsAnotherTrainFrame_13 pbframe;
...
class TrainHitsAnotherTrainFrame_13Vector 
	: private std::vector<TrainHitsAnotherTrainFrame_13>
{
	public:
	using std::vector<TrainHitsAnotherTrainFrame_13>::push_back;
	using std::vector<TrainHitsAnotherTrainFrame_13>::clear;
	using std::vector<TrainHitsAnotherTrainFrame_13>::empty;
	using std::vector<TrainHitsAnotherTrainFrame_13>::size;
	using std::vector<TrainHitsAnotherTrainFrame_13>::begin;
	using std::vector<TrainHitsAnotherTrainFrame_13>::end;
	...
	{
		PB_TrainHitsAnotherTrainFrame_13Vector pbFrameVector;
...
#endif /*  VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_13_H_ */
