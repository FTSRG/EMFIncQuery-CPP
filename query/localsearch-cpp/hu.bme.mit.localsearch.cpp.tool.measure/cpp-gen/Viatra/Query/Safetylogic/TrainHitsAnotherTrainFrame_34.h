#ifndef VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_34_H_
#define VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_34_H_
...
class TrainHitsAnotherTrainFrame_34Vector;

struct TrainHitsAnotherTrainFrame_34 {
	
	using PBFrame = PB_TrainHitsAnotherTrainFrame_34;
	using FrameVector = TrainHitsAnotherTrainFrame_34Vector;
	...
	{
		PB_TrainHitsAnotherTrainFrame_34 pbframe;
...
class TrainHitsAnotherTrainFrame_34Vector 
	: private std::vector<TrainHitsAnotherTrainFrame_34>
{
	public:
	using std::vector<TrainHitsAnotherTrainFrame_34>::push_back;
	using std::vector<TrainHitsAnotherTrainFrame_34>::clear;
	using std::vector<TrainHitsAnotherTrainFrame_34>::empty;
	using std::vector<TrainHitsAnotherTrainFrame_34>::size;
	using std::vector<TrainHitsAnotherTrainFrame_34>::begin;
	using std::vector<TrainHitsAnotherTrainFrame_34>::end;
	...
	{
		PB_TrainHitsAnotherTrainFrame_34Vector pbFrameVector;
...
#endif /*  VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_34_H_ */
