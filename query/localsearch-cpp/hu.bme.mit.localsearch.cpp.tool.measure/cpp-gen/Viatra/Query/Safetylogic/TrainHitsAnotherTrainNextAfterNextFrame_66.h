#ifndef VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_NEXT_AFTER_NEXT_FRAME_66_H_
#define VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_NEXT_AFTER_NEXT_FRAME_66_H_
...
class TrainHitsAnotherTrainNextAfterNextFrame_66Vector;

struct TrainHitsAnotherTrainNextAfterNextFrame_66 {
	
	using PBFrame = PB_TrainHitsAnotherTrainNextAfterNextFrame_66;
	using FrameVector = TrainHitsAnotherTrainNextAfterNextFrame_66Vector;
	...
	::railRoadModel::ISegment* _12 = nullptr;
	...
	{
		PB_TrainHitsAnotherTrainNextAfterNextFrame_66 pbframe;
	...
	void ParseFromString(std::string str, ModelRoot *mr)
	{
		...
		_12 = (pbframe._12() == -1) 
			? nullptr 
			: dynamic_cast<::railRoadModel::ISegment*>(mr->findModelElementByID(pbframe._12()));
...
class TrainHitsAnotherTrainNextAfterNextFrame_66Vector 
	: private std::vector<TrainHitsAnotherTrainNextAfterNextFrame_66>
{
	public:
	using std::vector<TrainHitsAnotherTrainNextAfterNextFrame_66>::push_back;
	using std::vector<TrainHitsAnotherTrainNextAfterNextFrame_66>::clear;
	using std::vector<TrainHitsAnotherTrainNextAfterNextFrame_66>::empty;
	using std::vector<TrainHitsAnotherTrainNextAfterNextFrame_66>::size;
	using std::vector<TrainHitsAnotherTrainNextAfterNextFrame_66>::begin;
	using std::vector<TrainHitsAnotherTrainNextAfterNextFrame_66>::end;
	...
	{
		PB_TrainHitsAnotherTrainNextAfterNextFrame_66Vector pbFrameVector;
...
#endif /*  VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_NEXT_AFTER_NEXT_FRAME_66_H_ */
