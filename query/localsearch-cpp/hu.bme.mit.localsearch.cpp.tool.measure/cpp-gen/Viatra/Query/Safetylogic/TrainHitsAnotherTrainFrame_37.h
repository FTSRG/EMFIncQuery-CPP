#ifndef VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_37_H_
#define VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_37_H_
...
class TrainHitsAnotherTrainFrame_37Vector;

struct TrainHitsAnotherTrainFrame_37 {
	
	using PBFrame = PB_TrainHitsAnotherTrainFrame_37;
	using FrameVector = TrainHitsAnotherTrainFrame_37Vector;
	...
	{
		PB_TrainHitsAnotherTrainFrame_37 pbframe;
...
class TrainHitsAnotherTrainFrame_37Vector 
	: private std::vector<TrainHitsAnotherTrainFrame_37>
{
	public:
	using std::vector<TrainHitsAnotherTrainFrame_37>::push_back;
	using std::vector<TrainHitsAnotherTrainFrame_37>::clear;
	using std::vector<TrainHitsAnotherTrainFrame_37>::empty;
	using std::vector<TrainHitsAnotherTrainFrame_37>::size;
	using std::vector<TrainHitsAnotherTrainFrame_37>::begin;
	using std::vector<TrainHitsAnotherTrainFrame_37>::end;
	...
	{
		PB_TrainHitsAnotherTrainFrame_37Vector pbFrameVector;
...
#endif /*  VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_37_H_ */
