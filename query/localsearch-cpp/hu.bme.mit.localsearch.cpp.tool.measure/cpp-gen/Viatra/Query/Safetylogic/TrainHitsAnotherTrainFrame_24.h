#ifndef VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_24_H_
#define VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_24_H_
...
class TrainHitsAnotherTrainFrame_24Vector;

struct TrainHitsAnotherTrainFrame_24 {
	
	using PBFrame = PB_TrainHitsAnotherTrainFrame_24;
	using FrameVector = TrainHitsAnotherTrainFrame_24Vector;
	...
	{
		PB_TrainHitsAnotherTrainFrame_24 pbframe;
...
class TrainHitsAnotherTrainFrame_24Vector 
	: private std::vector<TrainHitsAnotherTrainFrame_24>
{
	public:
	using std::vector<TrainHitsAnotherTrainFrame_24>::push_back;
	using std::vector<TrainHitsAnotherTrainFrame_24>::clear;
	using std::vector<TrainHitsAnotherTrainFrame_24>::empty;
	using std::vector<TrainHitsAnotherTrainFrame_24>::size;
	using std::vector<TrainHitsAnotherTrainFrame_24>::begin;
	using std::vector<TrainHitsAnotherTrainFrame_24>::end;
	...
	{
		PB_TrainHitsAnotherTrainFrame_24Vector pbFrameVector;
...
#endif /*  VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_24_H_ */
