#ifndef VIATRA__QUERY__SAFETYLOGIC__TRAINS_ARE_TOO_CLOSE_FRAME_1_H_
#define VIATRA__QUERY__SAFETYLOGIC__TRAINS_ARE_TOO_CLOSE_FRAME_1_H_
...
class TrainsAreTooCloseFrame_1Vector;

struct TrainsAreTooCloseFrame_1 {
	
	using PBFrame = PB_TrainsAreTooCloseFrame_1;
	using FrameVector = TrainsAreTooCloseFrame_1Vector;
	...
	{
		PB_TrainsAreTooCloseFrame_1 pbframe;
...
class TrainsAreTooCloseFrame_1Vector 
	: private std::vector<TrainsAreTooCloseFrame_1>
{
	public:
	using std::vector<TrainsAreTooCloseFrame_1>::push_back;
	using std::vector<TrainsAreTooCloseFrame_1>::clear;
	using std::vector<TrainsAreTooCloseFrame_1>::empty;
	using std::vector<TrainsAreTooCloseFrame_1>::size;
	using std::vector<TrainsAreTooCloseFrame_1>::begin;
	using std::vector<TrainsAreTooCloseFrame_1>::end;
	...
	{
		PB_TrainsAreTooCloseFrame_1Vector pbFrameVector;
...
#endif /*  VIATRA__QUERY__SAFETYLOGIC__TRAINS_ARE_TOO_CLOSE_FRAME_1_H_ */
