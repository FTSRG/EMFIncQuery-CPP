#ifndef VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_NEXT_AFTER_NEXT_FRAME_67_H_
#define VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_NEXT_AFTER_NEXT_FRAME_67_H_
...
class TrainHitsAnotherTrainNextAfterNextFrame_67Vector;

struct TrainHitsAnotherTrainNextAfterNextFrame_67 {
	
	using PBFrame = PB_TrainHitsAnotherTrainNextAfterNextFrame_67;
	using FrameVector = TrainHitsAnotherTrainNextAfterNextFrame_67Vector;
	
	::railRoadModel::ITrain* _0 = nullptr;
	::railRoadModel::ITrain* _1 = nullptr;
	::railRoadModel::ISegment* _2 = nullptr;
	...
	{
		PB_TrainHitsAnotherTrainNextAfterNextFrame_67 pbframe;
...
class TrainHitsAnotherTrainNextAfterNextFrame_67Vector 
	: private std::vector<TrainHitsAnotherTrainNextAfterNextFrame_67>
{
	public:
	using std::vector<TrainHitsAnotherTrainNextAfterNextFrame_67>::push_back;
	using std::vector<TrainHitsAnotherTrainNextAfterNextFrame_67>::clear;
	using std::vector<TrainHitsAnotherTrainNextAfterNextFrame_67>::empty;
	using std::vector<TrainHitsAnotherTrainNextAfterNextFrame_67>::size;
	using std::vector<TrainHitsAnotherTrainNextAfterNextFrame_67>::begin;
	using std::vector<TrainHitsAnotherTrainNextAfterNextFrame_67>::end;
	...
	{
		PB_TrainHitsAnotherTrainNextAfterNextFrame_67Vector pbFrameVector;
...
#endif /*  VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_NEXT_AFTER_NEXT_FRAME_67_H_ */
