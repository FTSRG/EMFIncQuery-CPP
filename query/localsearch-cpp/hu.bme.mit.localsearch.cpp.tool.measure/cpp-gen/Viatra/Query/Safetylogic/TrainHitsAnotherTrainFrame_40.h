#ifndef VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_40_H_
#define VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_40_H_
...
class TrainHitsAnotherTrainFrame_40Vector;

struct TrainHitsAnotherTrainFrame_40 {
	
	using PBFrame = PB_TrainHitsAnotherTrainFrame_40;
	using FrameVector = TrainHitsAnotherTrainFrame_40Vector;
	...
	{
		PB_TrainHitsAnotherTrainFrame_40 pbframe;
...
class TrainHitsAnotherTrainFrame_40Vector 
	: private std::vector<TrainHitsAnotherTrainFrame_40>
{
	public:
	using std::vector<TrainHitsAnotherTrainFrame_40>::push_back;
	using std::vector<TrainHitsAnotherTrainFrame_40>::clear;
	using std::vector<TrainHitsAnotherTrainFrame_40>::empty;
	using std::vector<TrainHitsAnotherTrainFrame_40>::size;
	using std::vector<TrainHitsAnotherTrainFrame_40>::begin;
	using std::vector<TrainHitsAnotherTrainFrame_40>::end;
	...
	{
		PB_TrainHitsAnotherTrainFrame_40Vector pbFrameVector;
...
#endif /*  VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_40_H_ */
