#ifndef VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_11_H_
#define VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_11_H_
...
class TrainHitsAnotherTrainFrame_11Vector;

struct TrainHitsAnotherTrainFrame_11 {
	
	using PBFrame = PB_TrainHitsAnotherTrainFrame_11;
	using FrameVector = TrainHitsAnotherTrainFrame_11Vector;
	...
	{
		PB_TrainHitsAnotherTrainFrame_11 pbframe;
...
class TrainHitsAnotherTrainFrame_11Vector 
	: private std::vector<TrainHitsAnotherTrainFrame_11>
{
	public:
	using std::vector<TrainHitsAnotherTrainFrame_11>::push_back;
	using std::vector<TrainHitsAnotherTrainFrame_11>::clear;
	using std::vector<TrainHitsAnotherTrainFrame_11>::empty;
	using std::vector<TrainHitsAnotherTrainFrame_11>::size;
	using std::vector<TrainHitsAnotherTrainFrame_11>::begin;
	using std::vector<TrainHitsAnotherTrainFrame_11>::end;
	...
	{
		PB_TrainHitsAnotherTrainFrame_11Vector pbFrameVector;
...
#endif /*  VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_11_H_ */
