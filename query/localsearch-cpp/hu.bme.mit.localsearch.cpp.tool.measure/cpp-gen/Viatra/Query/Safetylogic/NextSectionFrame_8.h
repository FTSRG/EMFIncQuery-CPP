#ifndef VIATRA__QUERY__SAFETYLOGIC__NEXT_SECTION_FRAME_8_H_
#define VIATRA__QUERY__SAFETYLOGIC__NEXT_SECTION_FRAME_8_H_
...
class NextSectionFrame_8Vector;

struct NextSectionFrame_8 {
	
	using PBFrame = PB_NextSectionFrame_8;
	using FrameVector = NextSectionFrame_8Vector;
...
class NextSectionFrame_8Vector 
	: private std::vector<NextSectionFrame_8>
{
	public:
	using std::vector<NextSectionFrame_8>::push_back;
	using std::vector<NextSectionFrame_8>::clear;
	using std::vector<NextSectionFrame_8>::empty;
	using std::vector<NextSectionFrame_8>::size;
	using std::vector<NextSectionFrame_8>::begin;
	using std::vector<NextSectionFrame_8>::end;
	...
	{
		PB_NextSectionFrame_8Vector pbFrameVector;
...
#endif /*  VIATRA__QUERY__SAFETYLOGIC__NEXT_SECTION_FRAME_8_H_ */
