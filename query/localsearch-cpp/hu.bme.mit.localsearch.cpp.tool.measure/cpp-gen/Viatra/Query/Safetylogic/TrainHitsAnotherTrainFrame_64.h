#ifndef VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_64_H_
#define VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_64_H_
...
class TrainHitsAnotherTrainFrame_64Vector;

struct TrainHitsAnotherTrainFrame_64 {
	
	using PBFrame = PB_TrainHitsAnotherTrainFrame_64;
	using FrameVector = TrainHitsAnotherTrainFrame_64Vector;
	...
	{
		PB_TrainHitsAnotherTrainFrame_64 pbframe;
...
class TrainHitsAnotherTrainFrame_64Vector 
	: private std::vector<TrainHitsAnotherTrainFrame_64>
{
	public:
	using std::vector<TrainHitsAnotherTrainFrame_64>::push_back;
	using std::vector<TrainHitsAnotherTrainFrame_64>::clear;
	using std::vector<TrainHitsAnotherTrainFrame_64>::empty;
	using std::vector<TrainHitsAnotherTrainFrame_64>::size;
	using std::vector<TrainHitsAnotherTrainFrame_64>::begin;
	using std::vector<TrainHitsAnotherTrainFrame_64>::end;
	...
	{
		PB_TrainHitsAnotherTrainFrame_64Vector pbFrameVector;
...
#endif /*  VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_64_H_ */
