#ifndef VIATRA__QUERY__SAFETYLOGIC__SHOULD_COLLIDE_MATCHER_H_
#define VIATRA__QUERY__SAFETYLOGIC__SHOULD_COLLIDE_MATCHER_H_
...
#endif /*  VIATRA__QUERY__SAFETYLOGIC__SHOULD_COLLIDE_MATCHER_H_ */
