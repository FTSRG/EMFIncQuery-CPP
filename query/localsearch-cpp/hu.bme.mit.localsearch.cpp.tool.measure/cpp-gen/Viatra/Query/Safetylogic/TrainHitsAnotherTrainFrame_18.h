#ifndef VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_18_H_
#define VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_18_H_
...
class TrainHitsAnotherTrainFrame_18Vector;

struct TrainHitsAnotherTrainFrame_18 {
	
	using PBFrame = PB_TrainHitsAnotherTrainFrame_18;
	using FrameVector = TrainHitsAnotherTrainFrame_18Vector;
	...
	{
		PB_TrainHitsAnotherTrainFrame_18 pbframe;
...
class TrainHitsAnotherTrainFrame_18Vector 
	: private std::vector<TrainHitsAnotherTrainFrame_18>
{
	public:
	using std::vector<TrainHitsAnotherTrainFrame_18>::push_back;
	using std::vector<TrainHitsAnotherTrainFrame_18>::clear;
	using std::vector<TrainHitsAnotherTrainFrame_18>::empty;
	using std::vector<TrainHitsAnotherTrainFrame_18>::size;
	using std::vector<TrainHitsAnotherTrainFrame_18>::begin;
	using std::vector<TrainHitsAnotherTrainFrame_18>::end;
	...
	{
		PB_TrainHitsAnotherTrainFrame_18Vector pbFrameVector;
...
#endif /*  VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_18_H_ */
