#ifndef VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_113_H_
#define VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_113_H_
...
class TrainHitsAnotherTrainFrame_113Vector;

struct TrainHitsAnotherTrainFrame_113 {
	
	using PBFrame = PB_TrainHitsAnotherTrainFrame_113;
	using FrameVector = TrainHitsAnotherTrainFrame_113Vector;
	...
	{
		PB_TrainHitsAnotherTrainFrame_113 pbframe;
...
class TrainHitsAnotherTrainFrame_113Vector 
	: private std::vector<TrainHitsAnotherTrainFrame_113>
{
	public:
	using std::vector<TrainHitsAnotherTrainFrame_113>::push_back;
	using std::vector<TrainHitsAnotherTrainFrame_113>::clear;
	using std::vector<TrainHitsAnotherTrainFrame_113>::empty;
	using std::vector<TrainHitsAnotherTrainFrame_113>::size;
	using std::vector<TrainHitsAnotherTrainFrame_113>::begin;
	using std::vector<TrainHitsAnotherTrainFrame_113>::end;
	...
	{
		PB_TrainHitsAnotherTrainFrame_113Vector pbFrameVector;
...
#endif /*  VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_113_H_ */
