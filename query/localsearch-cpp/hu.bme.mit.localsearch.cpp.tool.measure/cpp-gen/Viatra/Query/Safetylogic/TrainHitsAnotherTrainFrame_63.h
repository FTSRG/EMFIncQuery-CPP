#ifndef VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_63_H_
#define VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_63_H_
...
class TrainHitsAnotherTrainFrame_63Vector;

struct TrainHitsAnotherTrainFrame_63 {
	
	using PBFrame = PB_TrainHitsAnotherTrainFrame_63;
	using FrameVector = TrainHitsAnotherTrainFrame_63Vector;
	...
	{
		PB_TrainHitsAnotherTrainFrame_63 pbframe;
...
class TrainHitsAnotherTrainFrame_63Vector 
	: private std::vector<TrainHitsAnotherTrainFrame_63>
{
	public:
	using std::vector<TrainHitsAnotherTrainFrame_63>::push_back;
	using std::vector<TrainHitsAnotherTrainFrame_63>::clear;
	using std::vector<TrainHitsAnotherTrainFrame_63>::empty;
	using std::vector<TrainHitsAnotherTrainFrame_63>::size;
	using std::vector<TrainHitsAnotherTrainFrame_63>::begin;
	using std::vector<TrainHitsAnotherTrainFrame_63>::end;
	...
	{
		PB_TrainHitsAnotherTrainFrame_63Vector pbFrameVector;
...
#endif /*  VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_63_H_ */
