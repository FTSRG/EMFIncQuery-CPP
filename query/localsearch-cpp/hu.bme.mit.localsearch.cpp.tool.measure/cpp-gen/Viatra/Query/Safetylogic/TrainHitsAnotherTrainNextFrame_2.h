#ifndef VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_NEXT_FRAME_2_H_
#define VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_NEXT_FRAME_2_H_
...
class TrainHitsAnotherTrainNextFrame_2Vector;

struct TrainHitsAnotherTrainNextFrame_2 {
	
	using PBFrame = PB_TrainHitsAnotherTrainNextFrame_2;
	using FrameVector = TrainHitsAnotherTrainNextFrame_2Vector;
	...
	{
		PB_TrainHitsAnotherTrainNextFrame_2 pbframe;
...
class TrainHitsAnotherTrainNextFrame_2Vector 
	: private std::vector<TrainHitsAnotherTrainNextFrame_2>
{
	public:
	using std::vector<TrainHitsAnotherTrainNextFrame_2>::push_back;
	using std::vector<TrainHitsAnotherTrainNextFrame_2>::clear;
	using std::vector<TrainHitsAnotherTrainNextFrame_2>::empty;
	using std::vector<TrainHitsAnotherTrainNextFrame_2>::size;
	using std::vector<TrainHitsAnotherTrainNextFrame_2>::begin;
	using std::vector<TrainHitsAnotherTrainNextFrame_2>::end;
	...
	{
		PB_TrainHitsAnotherTrainNextFrame_2Vector pbFrameVector;
...
#endif /*  VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_NEXT_FRAME_2_H_ */
