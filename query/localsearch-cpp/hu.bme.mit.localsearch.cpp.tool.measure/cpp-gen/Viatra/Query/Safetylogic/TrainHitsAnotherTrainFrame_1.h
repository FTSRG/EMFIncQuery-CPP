#ifndef VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_1_H_
#define VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_1_H_
...
class TrainHitsAnotherTrainFrame_1Vector;

struct TrainHitsAnotherTrainFrame_1 {
	
	using PBFrame = PB_TrainHitsAnotherTrainFrame_1;
	using FrameVector = TrainHitsAnotherTrainFrame_1Vector;
	...
	{
		PB_TrainHitsAnotherTrainFrame_1 pbframe;
...
class TrainHitsAnotherTrainFrame_1Vector 
	: private std::vector<TrainHitsAnotherTrainFrame_1>
{
	public:
	using std::vector<TrainHitsAnotherTrainFrame_1>::push_back;
	using std::vector<TrainHitsAnotherTrainFrame_1>::clear;
	using std::vector<TrainHitsAnotherTrainFrame_1>::empty;
	using std::vector<TrainHitsAnotherTrainFrame_1>::size;
	using std::vector<TrainHitsAnotherTrainFrame_1>::begin;
	using std::vector<TrainHitsAnotherTrainFrame_1>::end;
	...
	{
		PB_TrainHitsAnotherTrainFrame_1Vector pbFrameVector;
...
#endif /*  VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_1_H_ */
