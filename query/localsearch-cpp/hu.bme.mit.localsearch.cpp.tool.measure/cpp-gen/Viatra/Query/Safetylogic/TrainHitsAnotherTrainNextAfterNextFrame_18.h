#ifndef VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_NEXT_AFTER_NEXT_FRAME_18_H_
#define VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_NEXT_AFTER_NEXT_FRAME_18_H_
...
class TrainHitsAnotherTrainNextAfterNextFrame_18Vector;

struct TrainHitsAnotherTrainNextAfterNextFrame_18 {
	
	using PBFrame = PB_TrainHitsAnotherTrainNextAfterNextFrame_18;
	using FrameVector = TrainHitsAnotherTrainNextAfterNextFrame_18Vector;
	...
	std::string toString() const
	{
		...
		ret += Viatra::Query::Util::Convert::ToString(_15);
	...
	{
		PB_TrainHitsAnotherTrainNextAfterNextFrame_18 pbframe;
...
class TrainHitsAnotherTrainNextAfterNextFrame_18Vector 
	: private std::vector<TrainHitsAnotherTrainNextAfterNextFrame_18>
{
	public:
	using std::vector<TrainHitsAnotherTrainNextAfterNextFrame_18>::push_back;
	using std::vector<TrainHitsAnotherTrainNextAfterNextFrame_18>::clear;
	using std::vector<TrainHitsAnotherTrainNextAfterNextFrame_18>::empty;
	using std::vector<TrainHitsAnotherTrainNextAfterNextFrame_18>::size;
	using std::vector<TrainHitsAnotherTrainNextAfterNextFrame_18>::begin;
	using std::vector<TrainHitsAnotherTrainNextAfterNextFrame_18>::end;
	...
	{
		PB_TrainHitsAnotherTrainNextAfterNextFrame_18Vector pbFrameVector;
	...
	std::string SerializeAsString()
	{
		...
		for(auto& storedVector: *this){
			...
			pbFrame.set__15(storedVector._15);
		}
...
#endif /*  VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_NEXT_AFTER_NEXT_FRAME_18_H_ */
