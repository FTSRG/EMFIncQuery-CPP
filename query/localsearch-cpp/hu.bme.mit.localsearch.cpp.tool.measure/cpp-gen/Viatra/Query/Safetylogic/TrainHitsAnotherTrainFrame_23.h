#ifndef VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_23_H_
#define VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_23_H_
...
class TrainHitsAnotherTrainFrame_23Vector;

struct TrainHitsAnotherTrainFrame_23 {
	
	using PBFrame = PB_TrainHitsAnotherTrainFrame_23;
	using FrameVector = TrainHitsAnotherTrainFrame_23Vector;
	...
	{
		PB_TrainHitsAnotherTrainFrame_23 pbframe;
...
class TrainHitsAnotherTrainFrame_23Vector 
	: private std::vector<TrainHitsAnotherTrainFrame_23>
{
	public:
	using std::vector<TrainHitsAnotherTrainFrame_23>::push_back;
	using std::vector<TrainHitsAnotherTrainFrame_23>::clear;
	using std::vector<TrainHitsAnotherTrainFrame_23>::empty;
	using std::vector<TrainHitsAnotherTrainFrame_23>::size;
	using std::vector<TrainHitsAnotherTrainFrame_23>::begin;
	using std::vector<TrainHitsAnotherTrainFrame_23>::end;
	...
	{
		PB_TrainHitsAnotherTrainFrame_23Vector pbFrameVector;
...
#endif /*  VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_23_H_ */
