#ifndef VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_74_H_
#define VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_74_H_
...
class TrainHitsAnotherTrainFrame_74Vector;

struct TrainHitsAnotherTrainFrame_74 {
	
	using PBFrame = PB_TrainHitsAnotherTrainFrame_74;
	using FrameVector = TrainHitsAnotherTrainFrame_74Vector;
	...
	{
		PB_TrainHitsAnotherTrainFrame_74 pbframe;
...
class TrainHitsAnotherTrainFrame_74Vector 
	: private std::vector<TrainHitsAnotherTrainFrame_74>
{
	public:
	using std::vector<TrainHitsAnotherTrainFrame_74>::push_back;
	using std::vector<TrainHitsAnotherTrainFrame_74>::clear;
	using std::vector<TrainHitsAnotherTrainFrame_74>::empty;
	using std::vector<TrainHitsAnotherTrainFrame_74>::size;
	using std::vector<TrainHitsAnotherTrainFrame_74>::begin;
	using std::vector<TrainHitsAnotherTrainFrame_74>::end;
	...
	{
		PB_TrainHitsAnotherTrainFrame_74Vector pbFrameVector;
...
#endif /*  VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_74_H_ */
