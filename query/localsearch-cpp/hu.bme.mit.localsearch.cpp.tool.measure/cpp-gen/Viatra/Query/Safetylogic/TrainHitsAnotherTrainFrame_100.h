#ifndef VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_100_H_
#define VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_100_H_
...
class TrainHitsAnotherTrainFrame_100Vector;

struct TrainHitsAnotherTrainFrame_100 {
	
	using PBFrame = PB_TrainHitsAnotherTrainFrame_100;
	using FrameVector = TrainHitsAnotherTrainFrame_100Vector;
	...
	{
		PB_TrainHitsAnotherTrainFrame_100 pbframe;
...
class TrainHitsAnotherTrainFrame_100Vector 
	: private std::vector<TrainHitsAnotherTrainFrame_100>
{
	public:
	using std::vector<TrainHitsAnotherTrainFrame_100>::push_back;
	using std::vector<TrainHitsAnotherTrainFrame_100>::clear;
	using std::vector<TrainHitsAnotherTrainFrame_100>::empty;
	using std::vector<TrainHitsAnotherTrainFrame_100>::size;
	using std::vector<TrainHitsAnotherTrainFrame_100>::begin;
	using std::vector<TrainHitsAnotherTrainFrame_100>::end;
	...
	{
		PB_TrainHitsAnotherTrainFrame_100Vector pbFrameVector;
...
#endif /*  VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_100_H_ */
