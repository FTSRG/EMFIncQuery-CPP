#ifndef VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_72_H_
#define VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_72_H_
...
class TrainHitsAnotherTrainFrame_72Vector;

struct TrainHitsAnotherTrainFrame_72 {
	
	using PBFrame = PB_TrainHitsAnotherTrainFrame_72;
	using FrameVector = TrainHitsAnotherTrainFrame_72Vector;
	...
	{
		PB_TrainHitsAnotherTrainFrame_72 pbframe;
...
class TrainHitsAnotherTrainFrame_72Vector 
	: private std::vector<TrainHitsAnotherTrainFrame_72>
{
	public:
	using std::vector<TrainHitsAnotherTrainFrame_72>::push_back;
	using std::vector<TrainHitsAnotherTrainFrame_72>::clear;
	using std::vector<TrainHitsAnotherTrainFrame_72>::empty;
	using std::vector<TrainHitsAnotherTrainFrame_72>::size;
	using std::vector<TrainHitsAnotherTrainFrame_72>::begin;
	using std::vector<TrainHitsAnotherTrainFrame_72>::end;
	...
	{
		PB_TrainHitsAnotherTrainFrame_72Vector pbFrameVector;
...
#endif /*  VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_72_H_ */
