#ifndef VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_NEXT_AFTER_NEXT_FRAME_82_H_
#define VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_NEXT_AFTER_NEXT_FRAME_82_H_
...
class TrainHitsAnotherTrainNextAfterNextFrame_82Vector;

struct TrainHitsAnotherTrainNextAfterNextFrame_82 {
	
	using PBFrame = PB_TrainHitsAnotherTrainNextAfterNextFrame_82;
	using FrameVector = TrainHitsAnotherTrainNextAfterNextFrame_82Vector;
	...
	std::string toString() const
	{
		...
		ret += Viatra::Query::Util::Convert::ToString(_14);
	...
	{
		PB_TrainHitsAnotherTrainNextAfterNextFrame_82 pbframe;
...
class TrainHitsAnotherTrainNextAfterNextFrame_82Vector 
	: private std::vector<TrainHitsAnotherTrainNextAfterNextFrame_82>
{
	public:
	using std::vector<TrainHitsAnotherTrainNextAfterNextFrame_82>::push_back;
	using std::vector<TrainHitsAnotherTrainNextAfterNextFrame_82>::clear;
	using std::vector<TrainHitsAnotherTrainNextAfterNextFrame_82>::empty;
	using std::vector<TrainHitsAnotherTrainNextAfterNextFrame_82>::size;
	using std::vector<TrainHitsAnotherTrainNextAfterNextFrame_82>::begin;
	using std::vector<TrainHitsAnotherTrainNextAfterNextFrame_82>::end;
	...
	{
		PB_TrainHitsAnotherTrainNextAfterNextFrame_82Vector pbFrameVector;
	...
	std::string SerializeAsString()
	{
		...
		for(auto& storedVector: *this){
			...
			pbFrame.set__14(storedVector._14);
		}
...
#endif /*  VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_NEXT_AFTER_NEXT_FRAME_82_H_ */
