#ifndef VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_99_H_
#define VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_99_H_
...
class TrainHitsAnotherTrainFrame_99Vector;

struct TrainHitsAnotherTrainFrame_99 {
	
	using PBFrame = PB_TrainHitsAnotherTrainFrame_99;
	using FrameVector = TrainHitsAnotherTrainFrame_99Vector;
	...
	{
		PB_TrainHitsAnotherTrainFrame_99 pbframe;
...
class TrainHitsAnotherTrainFrame_99Vector 
	: private std::vector<TrainHitsAnotherTrainFrame_99>
{
	public:
	using std::vector<TrainHitsAnotherTrainFrame_99>::push_back;
	using std::vector<TrainHitsAnotherTrainFrame_99>::clear;
	using std::vector<TrainHitsAnotherTrainFrame_99>::empty;
	using std::vector<TrainHitsAnotherTrainFrame_99>::size;
	using std::vector<TrainHitsAnotherTrainFrame_99>::begin;
	using std::vector<TrainHitsAnotherTrainFrame_99>::end;
	...
	{
		PB_TrainHitsAnotherTrainFrame_99Vector pbFrameVector;
...
#endif /*  VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_99_H_ */
