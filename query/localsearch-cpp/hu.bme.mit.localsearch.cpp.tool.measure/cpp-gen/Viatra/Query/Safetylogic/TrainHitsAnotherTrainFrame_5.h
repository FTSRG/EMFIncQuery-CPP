#ifndef VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_5_H_
#define VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_5_H_
...
class TrainHitsAnotherTrainFrame_5Vector;

struct TrainHitsAnotherTrainFrame_5 {
	
	using PBFrame = PB_TrainHitsAnotherTrainFrame_5;
	using FrameVector = TrainHitsAnotherTrainFrame_5Vector;
	...
	{
		PB_TrainHitsAnotherTrainFrame_5 pbframe;
...
class TrainHitsAnotherTrainFrame_5Vector 
	: private std::vector<TrainHitsAnotherTrainFrame_5>
{
	public:
	using std::vector<TrainHitsAnotherTrainFrame_5>::push_back;
	using std::vector<TrainHitsAnotherTrainFrame_5>::clear;
	using std::vector<TrainHitsAnotherTrainFrame_5>::empty;
	using std::vector<TrainHitsAnotherTrainFrame_5>::size;
	using std::vector<TrainHitsAnotherTrainFrame_5>::begin;
	using std::vector<TrainHitsAnotherTrainFrame_5>::end;
	...
	{
		PB_TrainHitsAnotherTrainFrame_5Vector pbFrameVector;
...
#endif /*  VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_5_H_ */
