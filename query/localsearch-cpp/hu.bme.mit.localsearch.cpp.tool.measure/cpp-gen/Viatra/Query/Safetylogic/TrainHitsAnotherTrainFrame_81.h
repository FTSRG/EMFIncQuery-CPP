#ifndef VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_81_H_
#define VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_81_H_
...
class TrainHitsAnotherTrainFrame_81Vector;

struct TrainHitsAnotherTrainFrame_81 {
	
	using PBFrame = PB_TrainHitsAnotherTrainFrame_81;
	using FrameVector = TrainHitsAnotherTrainFrame_81Vector;
	...
	{
		PB_TrainHitsAnotherTrainFrame_81 pbframe;
...
class TrainHitsAnotherTrainFrame_81Vector 
	: private std::vector<TrainHitsAnotherTrainFrame_81>
{
	public:
	using std::vector<TrainHitsAnotherTrainFrame_81>::push_back;
	using std::vector<TrainHitsAnotherTrainFrame_81>::clear;
	using std::vector<TrainHitsAnotherTrainFrame_81>::empty;
	using std::vector<TrainHitsAnotherTrainFrame_81>::size;
	using std::vector<TrainHitsAnotherTrainFrame_81>::begin;
	using std::vector<TrainHitsAnotherTrainFrame_81>::end;
	...
	{
		PB_TrainHitsAnotherTrainFrame_81Vector pbFrameVector;
...
#endif /*  VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_81_H_ */
