#ifndef VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_83_H_
#define VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_83_H_
...
class TrainHitsAnotherTrainFrame_83Vector;

struct TrainHitsAnotherTrainFrame_83 {
	
	using PBFrame = PB_TrainHitsAnotherTrainFrame_83;
	using FrameVector = TrainHitsAnotherTrainFrame_83Vector;
	...
	{
		PB_TrainHitsAnotherTrainFrame_83 pbframe;
...
class TrainHitsAnotherTrainFrame_83Vector 
	: private std::vector<TrainHitsAnotherTrainFrame_83>
{
	public:
	using std::vector<TrainHitsAnotherTrainFrame_83>::push_back;
	using std::vector<TrainHitsAnotherTrainFrame_83>::clear;
	using std::vector<TrainHitsAnotherTrainFrame_83>::empty;
	using std::vector<TrainHitsAnotherTrainFrame_83>::size;
	using std::vector<TrainHitsAnotherTrainFrame_83>::begin;
	using std::vector<TrainHitsAnotherTrainFrame_83>::end;
	...
	{
		PB_TrainHitsAnotherTrainFrame_83Vector pbFrameVector;
...
#endif /*  VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_83_H_ */
