#ifndef VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_NEXT_FRAME_1_H_
#define VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_NEXT_FRAME_1_H_
...
class TrainHitsAnotherTrainNextFrame_1Vector;

struct TrainHitsAnotherTrainNextFrame_1 {
	
	using PBFrame = PB_TrainHitsAnotherTrainNextFrame_1;
	using FrameVector = TrainHitsAnotherTrainNextFrame_1Vector;
	...
	{
		PB_TrainHitsAnotherTrainNextFrame_1 pbframe;
...
class TrainHitsAnotherTrainNextFrame_1Vector 
	: private std::vector<TrainHitsAnotherTrainNextFrame_1>
{
	public:
	using std::vector<TrainHitsAnotherTrainNextFrame_1>::push_back;
	using std::vector<TrainHitsAnotherTrainNextFrame_1>::clear;
	using std::vector<TrainHitsAnotherTrainNextFrame_1>::empty;
	using std::vector<TrainHitsAnotherTrainNextFrame_1>::size;
	using std::vector<TrainHitsAnotherTrainNextFrame_1>::begin;
	using std::vector<TrainHitsAnotherTrainNextFrame_1>::end;
	...
	{
		PB_TrainHitsAnotherTrainNextFrame_1Vector pbFrameVector;
...
#endif /*  VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_NEXT_FRAME_1_H_ */
