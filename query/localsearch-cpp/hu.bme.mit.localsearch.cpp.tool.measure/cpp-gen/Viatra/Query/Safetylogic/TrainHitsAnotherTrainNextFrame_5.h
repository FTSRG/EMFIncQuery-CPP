#ifndef VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_NEXT_FRAME_5_H_
#define VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_NEXT_FRAME_5_H_
...
class TrainHitsAnotherTrainNextFrame_5Vector;

struct TrainHitsAnotherTrainNextFrame_5 {
	
	using PBFrame = PB_TrainHitsAnotherTrainNextFrame_5;
	using FrameVector = TrainHitsAnotherTrainNextFrame_5Vector;
	...
	{
		PB_TrainHitsAnotherTrainNextFrame_5 pbframe;
...
class TrainHitsAnotherTrainNextFrame_5Vector 
	: private std::vector<TrainHitsAnotherTrainNextFrame_5>
{
	public:
	using std::vector<TrainHitsAnotherTrainNextFrame_5>::push_back;
	using std::vector<TrainHitsAnotherTrainNextFrame_5>::clear;
	using std::vector<TrainHitsAnotherTrainNextFrame_5>::empty;
	using std::vector<TrainHitsAnotherTrainNextFrame_5>::size;
	using std::vector<TrainHitsAnotherTrainNextFrame_5>::begin;
	using std::vector<TrainHitsAnotherTrainNextFrame_5>::end;
	...
	{
		PB_TrainHitsAnotherTrainNextFrame_5Vector pbFrameVector;
...
#endif /*  VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_NEXT_FRAME_5_H_ */
