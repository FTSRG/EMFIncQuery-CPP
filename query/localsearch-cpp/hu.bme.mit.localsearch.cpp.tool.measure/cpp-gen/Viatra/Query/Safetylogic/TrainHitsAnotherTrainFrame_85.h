#ifndef VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_85_H_
#define VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_85_H_
...
class TrainHitsAnotherTrainFrame_85Vector;

struct TrainHitsAnotherTrainFrame_85 {
	
	using PBFrame = PB_TrainHitsAnotherTrainFrame_85;
	using FrameVector = TrainHitsAnotherTrainFrame_85Vector;
	...
	{
		PB_TrainHitsAnotherTrainFrame_85 pbframe;
...
class TrainHitsAnotherTrainFrame_85Vector 
	: private std::vector<TrainHitsAnotherTrainFrame_85>
{
	public:
	using std::vector<TrainHitsAnotherTrainFrame_85>::push_back;
	using std::vector<TrainHitsAnotherTrainFrame_85>::clear;
	using std::vector<TrainHitsAnotherTrainFrame_85>::empty;
	using std::vector<TrainHitsAnotherTrainFrame_85>::size;
	using std::vector<TrainHitsAnotherTrainFrame_85>::begin;
	using std::vector<TrainHitsAnotherTrainFrame_85>::end;
	...
	{
		PB_TrainHitsAnotherTrainFrame_85Vector pbFrameVector;
...
#endif /*  VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_85_H_ */
