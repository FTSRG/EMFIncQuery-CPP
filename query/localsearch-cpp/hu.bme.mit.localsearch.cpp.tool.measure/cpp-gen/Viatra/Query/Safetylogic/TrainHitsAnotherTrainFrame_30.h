#ifndef VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_30_H_
#define VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_30_H_
...
class TrainHitsAnotherTrainFrame_30Vector;

struct TrainHitsAnotherTrainFrame_30 {
	
	using PBFrame = PB_TrainHitsAnotherTrainFrame_30;
	using FrameVector = TrainHitsAnotherTrainFrame_30Vector;
	...
	{
		PB_TrainHitsAnotherTrainFrame_30 pbframe;
...
class TrainHitsAnotherTrainFrame_30Vector 
	: private std::vector<TrainHitsAnotherTrainFrame_30>
{
	public:
	using std::vector<TrainHitsAnotherTrainFrame_30>::push_back;
	using std::vector<TrainHitsAnotherTrainFrame_30>::clear;
	using std::vector<TrainHitsAnotherTrainFrame_30>::empty;
	using std::vector<TrainHitsAnotherTrainFrame_30>::size;
	using std::vector<TrainHitsAnotherTrainFrame_30>::begin;
	using std::vector<TrainHitsAnotherTrainFrame_30>::end;
	...
	{
		PB_TrainHitsAnotherTrainFrame_30Vector pbFrameVector;
...
#endif /*  VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_30_H_ */
