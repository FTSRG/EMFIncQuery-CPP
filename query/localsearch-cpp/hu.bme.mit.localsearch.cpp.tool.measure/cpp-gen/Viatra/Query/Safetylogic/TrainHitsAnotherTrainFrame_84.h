#ifndef VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_84_H_
#define VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_84_H_
...
class TrainHitsAnotherTrainFrame_84Vector;

struct TrainHitsAnotherTrainFrame_84 {
	
	using PBFrame = PB_TrainHitsAnotherTrainFrame_84;
	using FrameVector = TrainHitsAnotherTrainFrame_84Vector;
	...
	{
		PB_TrainHitsAnotherTrainFrame_84 pbframe;
...
class TrainHitsAnotherTrainFrame_84Vector 
	: private std::vector<TrainHitsAnotherTrainFrame_84>
{
	public:
	using std::vector<TrainHitsAnotherTrainFrame_84>::push_back;
	using std::vector<TrainHitsAnotherTrainFrame_84>::clear;
	using std::vector<TrainHitsAnotherTrainFrame_84>::empty;
	using std::vector<TrainHitsAnotherTrainFrame_84>::size;
	using std::vector<TrainHitsAnotherTrainFrame_84>::begin;
	using std::vector<TrainHitsAnotherTrainFrame_84>::end;
	...
	{
		PB_TrainHitsAnotherTrainFrame_84Vector pbFrameVector;
...
#endif /*  VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_84_H_ */
