#ifndef VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_3_H_
#define VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_3_H_
...
class TrainHitsAnotherTrainFrame_3Vector;

struct TrainHitsAnotherTrainFrame_3 {
	
	using PBFrame = PB_TrainHitsAnotherTrainFrame_3;
	using FrameVector = TrainHitsAnotherTrainFrame_3Vector;
	...
	{
		PB_TrainHitsAnotherTrainFrame_3 pbframe;
...
class TrainHitsAnotherTrainFrame_3Vector 
	: private std::vector<TrainHitsAnotherTrainFrame_3>
{
	public:
	using std::vector<TrainHitsAnotherTrainFrame_3>::push_back;
	using std::vector<TrainHitsAnotherTrainFrame_3>::clear;
	using std::vector<TrainHitsAnotherTrainFrame_3>::empty;
	using std::vector<TrainHitsAnotherTrainFrame_3>::size;
	using std::vector<TrainHitsAnotherTrainFrame_3>::begin;
	using std::vector<TrainHitsAnotherTrainFrame_3>::end;
	...
	{
		PB_TrainHitsAnotherTrainFrame_3Vector pbFrameVector;
...
#endif /*  VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_3_H_ */
