#ifndef VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_76_H_
#define VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_76_H_
...
class TrainHitsAnotherTrainFrame_76Vector;

struct TrainHitsAnotherTrainFrame_76 {
	
	using PBFrame = PB_TrainHitsAnotherTrainFrame_76;
	using FrameVector = TrainHitsAnotherTrainFrame_76Vector;
	...
	{
		PB_TrainHitsAnotherTrainFrame_76 pbframe;
...
class TrainHitsAnotherTrainFrame_76Vector 
	: private std::vector<TrainHitsAnotherTrainFrame_76>
{
	public:
	using std::vector<TrainHitsAnotherTrainFrame_76>::push_back;
	using std::vector<TrainHitsAnotherTrainFrame_76>::clear;
	using std::vector<TrainHitsAnotherTrainFrame_76>::empty;
	using std::vector<TrainHitsAnotherTrainFrame_76>::size;
	using std::vector<TrainHitsAnotherTrainFrame_76>::begin;
	using std::vector<TrainHitsAnotherTrainFrame_76>::end;
	...
	{
		PB_TrainHitsAnotherTrainFrame_76Vector pbFrameVector;
...
#endif /*  VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_76_H_ */
