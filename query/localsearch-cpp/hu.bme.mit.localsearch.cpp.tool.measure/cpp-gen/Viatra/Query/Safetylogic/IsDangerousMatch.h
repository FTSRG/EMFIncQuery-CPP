#ifndef VIATRA__QUERY__SAFETYLOGIC__IS_DANGEROUS_MATCH_H_
#define VIATRA__QUERY__SAFETYLOGIC__IS_DANGEROUS_MATCH_H_
...
template<> struct hash<::Viatra::Query::Safetylogic::IsDangerousMatch> {
	size_t operator()(const ::Viatra::Query::Safetylogic::IsDangerousMatch& match) const {
		size_t h = 0;
...
#endif /*  VIATRA__QUERY__SAFETYLOGIC__IS_DANGEROUS_MATCH_H_ */
