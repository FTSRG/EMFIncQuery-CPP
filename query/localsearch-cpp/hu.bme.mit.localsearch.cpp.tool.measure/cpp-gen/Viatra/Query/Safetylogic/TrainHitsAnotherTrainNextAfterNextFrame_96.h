#ifndef VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_NEXT_AFTER_NEXT_FRAME_96_H_
#define VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_NEXT_AFTER_NEXT_FRAME_96_H_
...
class TrainHitsAnotherTrainNextAfterNextFrame_96Vector;

struct TrainHitsAnotherTrainNextAfterNextFrame_96 {
	
	using PBFrame = PB_TrainHitsAnotherTrainNextAfterNextFrame_96;
	using FrameVector = TrainHitsAnotherTrainNextAfterNextFrame_96Vector;
	...
	::railRoadModel::ISegment* _6 = nullptr;
	::railRoadModel::IRailRoadElement* _7 = nullptr;
	::railRoadModel::IPath* _8 = nullptr;
	::railRoadModel::IRailRoadElement* _9 = nullptr;
	::railRoadModel::ISegment* _10 = nullptr;
	...
	std::string toString() const
	{
		...
		ret += ",nextSection<1>_viablePaths<0>_connected2=";
		...
		ret += ",nextSection<1>_viablePaths<0>_connected1=";
	...
	{
		PB_TrainHitsAnotherTrainNextAfterNextFrame_96 pbframe;
	...
	void ParseFromString(std::string str, ModelRoot *mr)
	{
		...
		_6 = (pbframe._6() == -1) 
			? nullptr 
			: dynamic_cast<::railRoadModel::ISegment*>(mr->findModelElementByID(pbframe._6()));
		...
		_8 = (pbframe._8() == -1) 
			? nullptr 
			: dynamic_cast<::railRoadModel::IPath*>(mr->findModelElementByID(pbframe._8()));
		...
		_10 = (pbframe._10() == -1) 
			? nullptr 
			: dynamic_cast<::railRoadModel::ISegment*>(mr->findModelElementByID(pbframe._10()));
...
class TrainHitsAnotherTrainNextAfterNextFrame_96Vector 
	: private std::vector<TrainHitsAnotherTrainNextAfterNextFrame_96>
{
	public:
	using std::vector<TrainHitsAnotherTrainNextAfterNextFrame_96>::push_back;
	using std::vector<TrainHitsAnotherTrainNextAfterNextFrame_96>::clear;
	using std::vector<TrainHitsAnotherTrainNextAfterNextFrame_96>::empty;
	using std::vector<TrainHitsAnotherTrainNextAfterNextFrame_96>::size;
	using std::vector<TrainHitsAnotherTrainNextAfterNextFrame_96>::begin;
	using std::vector<TrainHitsAnotherTrainNextAfterNextFrame_96>::end;
	...
	{
		PB_TrainHitsAnotherTrainNextAfterNextFrame_96Vector pbFrameVector;
...
#endif /*  VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_NEXT_AFTER_NEXT_FRAME_96_H_ */
