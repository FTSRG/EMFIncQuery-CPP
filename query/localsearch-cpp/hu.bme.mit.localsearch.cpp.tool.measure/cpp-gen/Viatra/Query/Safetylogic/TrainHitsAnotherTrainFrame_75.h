#ifndef VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_75_H_
#define VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_75_H_
...
class TrainHitsAnotherTrainFrame_75Vector;

struct TrainHitsAnotherTrainFrame_75 {
	
	using PBFrame = PB_TrainHitsAnotherTrainFrame_75;
	using FrameVector = TrainHitsAnotherTrainFrame_75Vector;
	...
	{
		PB_TrainHitsAnotherTrainFrame_75 pbframe;
...
class TrainHitsAnotherTrainFrame_75Vector 
	: private std::vector<TrainHitsAnotherTrainFrame_75>
{
	public:
	using std::vector<TrainHitsAnotherTrainFrame_75>::push_back;
	using std::vector<TrainHitsAnotherTrainFrame_75>::clear;
	using std::vector<TrainHitsAnotherTrainFrame_75>::empty;
	using std::vector<TrainHitsAnotherTrainFrame_75>::size;
	using std::vector<TrainHitsAnotherTrainFrame_75>::begin;
	using std::vector<TrainHitsAnotherTrainFrame_75>::end;
	...
	{
		PB_TrainHitsAnotherTrainFrame_75Vector pbFrameVector;
...
#endif /*  VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_75_H_ */
