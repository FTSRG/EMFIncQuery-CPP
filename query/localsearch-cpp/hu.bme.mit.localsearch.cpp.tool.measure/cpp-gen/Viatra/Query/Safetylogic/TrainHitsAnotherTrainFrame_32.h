#ifndef VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_32_H_
#define VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_32_H_
...
class TrainHitsAnotherTrainFrame_32Vector;

struct TrainHitsAnotherTrainFrame_32 {
	
	using PBFrame = PB_TrainHitsAnotherTrainFrame_32;
	using FrameVector = TrainHitsAnotherTrainFrame_32Vector;
	...
	{
		PB_TrainHitsAnotherTrainFrame_32 pbframe;
...
class TrainHitsAnotherTrainFrame_32Vector 
	: private std::vector<TrainHitsAnotherTrainFrame_32>
{
	public:
	using std::vector<TrainHitsAnotherTrainFrame_32>::push_back;
	using std::vector<TrainHitsAnotherTrainFrame_32>::clear;
	using std::vector<TrainHitsAnotherTrainFrame_32>::empty;
	using std::vector<TrainHitsAnotherTrainFrame_32>::size;
	using std::vector<TrainHitsAnotherTrainFrame_32>::begin;
	using std::vector<TrainHitsAnotherTrainFrame_32>::end;
	...
	{
		PB_TrainHitsAnotherTrainFrame_32Vector pbFrameVector;
...
#endif /*  VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_32_H_ */
