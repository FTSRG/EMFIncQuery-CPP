#ifndef VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_93_H_
#define VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_93_H_
...
class TrainHitsAnotherTrainFrame_93Vector;

struct TrainHitsAnotherTrainFrame_93 {
	
	using PBFrame = PB_TrainHitsAnotherTrainFrame_93;
	using FrameVector = TrainHitsAnotherTrainFrame_93Vector;
	...
	{
		PB_TrainHitsAnotherTrainFrame_93 pbframe;
...
class TrainHitsAnotherTrainFrame_93Vector 
	: private std::vector<TrainHitsAnotherTrainFrame_93>
{
	public:
	using std::vector<TrainHitsAnotherTrainFrame_93>::push_back;
	using std::vector<TrainHitsAnotherTrainFrame_93>::clear;
	using std::vector<TrainHitsAnotherTrainFrame_93>::empty;
	using std::vector<TrainHitsAnotherTrainFrame_93>::size;
	using std::vector<TrainHitsAnotherTrainFrame_93>::begin;
	using std::vector<TrainHitsAnotherTrainFrame_93>::end;
	...
	{
		PB_TrainHitsAnotherTrainFrame_93Vector pbFrameVector;
...
#endif /*  VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_93_H_ */
