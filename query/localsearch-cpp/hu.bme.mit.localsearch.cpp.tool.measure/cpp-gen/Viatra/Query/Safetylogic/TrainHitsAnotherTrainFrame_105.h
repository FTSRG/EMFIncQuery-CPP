#ifndef VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_105_H_
#define VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_105_H_
...
class TrainHitsAnotherTrainFrame_105Vector;

struct TrainHitsAnotherTrainFrame_105 {
	
	using PBFrame = PB_TrainHitsAnotherTrainFrame_105;
	using FrameVector = TrainHitsAnotherTrainFrame_105Vector;
	...
	{
		PB_TrainHitsAnotherTrainFrame_105 pbframe;
...
class TrainHitsAnotherTrainFrame_105Vector 
	: private std::vector<TrainHitsAnotherTrainFrame_105>
{
	public:
	using std::vector<TrainHitsAnotherTrainFrame_105>::push_back;
	using std::vector<TrainHitsAnotherTrainFrame_105>::clear;
	using std::vector<TrainHitsAnotherTrainFrame_105>::empty;
	using std::vector<TrainHitsAnotherTrainFrame_105>::size;
	using std::vector<TrainHitsAnotherTrainFrame_105>::begin;
	using std::vector<TrainHitsAnotherTrainFrame_105>::end;
	...
	{
		PB_TrainHitsAnotherTrainFrame_105Vector pbFrameVector;
...
#endif /*  VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_105_H_ */
