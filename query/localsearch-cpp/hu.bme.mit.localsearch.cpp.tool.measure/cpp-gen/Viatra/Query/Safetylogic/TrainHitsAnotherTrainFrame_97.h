#ifndef VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_97_H_
#define VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_97_H_
...
class TrainHitsAnotherTrainFrame_97Vector;

struct TrainHitsAnotherTrainFrame_97 {
	
	using PBFrame = PB_TrainHitsAnotherTrainFrame_97;
	using FrameVector = TrainHitsAnotherTrainFrame_97Vector;
	...
	{
		PB_TrainHitsAnotherTrainFrame_97 pbframe;
...
class TrainHitsAnotherTrainFrame_97Vector 
	: private std::vector<TrainHitsAnotherTrainFrame_97>
{
	public:
	using std::vector<TrainHitsAnotherTrainFrame_97>::push_back;
	using std::vector<TrainHitsAnotherTrainFrame_97>::clear;
	using std::vector<TrainHitsAnotherTrainFrame_97>::empty;
	using std::vector<TrainHitsAnotherTrainFrame_97>::size;
	using std::vector<TrainHitsAnotherTrainFrame_97>::begin;
	using std::vector<TrainHitsAnotherTrainFrame_97>::end;
	...
	{
		PB_TrainHitsAnotherTrainFrame_97Vector pbFrameVector;
...
#endif /*  VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_97_H_ */
