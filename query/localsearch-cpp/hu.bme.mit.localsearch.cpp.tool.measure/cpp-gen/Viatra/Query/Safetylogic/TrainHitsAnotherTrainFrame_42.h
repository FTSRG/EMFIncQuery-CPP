#ifndef VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_42_H_
#define VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_42_H_
...
class TrainHitsAnotherTrainFrame_42Vector;

struct TrainHitsAnotherTrainFrame_42 {
	
	using PBFrame = PB_TrainHitsAnotherTrainFrame_42;
	using FrameVector = TrainHitsAnotherTrainFrame_42Vector;
	...
	std::string toString() const
	{
		...
		ret += ",trainHitsAnotherTrainNext<0>_nextSection<0>_viablePaths<0>_connected2=";
		...
		ret += ",trainHitsAnotherTrainNext<0>_nextSection<0>_viablePaths<0>_connected1=";
	...
	{
		PB_TrainHitsAnotherTrainFrame_42 pbframe;
...
class TrainHitsAnotherTrainFrame_42Vector 
	: private std::vector<TrainHitsAnotherTrainFrame_42>
{
	public:
	using std::vector<TrainHitsAnotherTrainFrame_42>::push_back;
	using std::vector<TrainHitsAnotherTrainFrame_42>::clear;
	using std::vector<TrainHitsAnotherTrainFrame_42>::empty;
	using std::vector<TrainHitsAnotherTrainFrame_42>::size;
	using std::vector<TrainHitsAnotherTrainFrame_42>::begin;
	using std::vector<TrainHitsAnotherTrainFrame_42>::end;
	...
	{
		PB_TrainHitsAnotherTrainFrame_42Vector pbFrameVector;
...
#endif /*  VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_42_H_ */
