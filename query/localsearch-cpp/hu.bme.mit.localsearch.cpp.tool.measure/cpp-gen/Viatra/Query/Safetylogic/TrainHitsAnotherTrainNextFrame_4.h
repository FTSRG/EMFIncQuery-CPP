#ifndef VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_NEXT_FRAME_4_H_
#define VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_NEXT_FRAME_4_H_
...
class TrainHitsAnotherTrainNextFrame_4Vector;

struct TrainHitsAnotherTrainNextFrame_4 {
	
	using PBFrame = PB_TrainHitsAnotherTrainNextFrame_4;
	using FrameVector = TrainHitsAnotherTrainNextFrame_4Vector;
	...
	{
		PB_TrainHitsAnotherTrainNextFrame_4 pbframe;
...
class TrainHitsAnotherTrainNextFrame_4Vector 
	: private std::vector<TrainHitsAnotherTrainNextFrame_4>
{
	public:
	using std::vector<TrainHitsAnotherTrainNextFrame_4>::push_back;
	using std::vector<TrainHitsAnotherTrainNextFrame_4>::clear;
	using std::vector<TrainHitsAnotherTrainNextFrame_4>::empty;
	using std::vector<TrainHitsAnotherTrainNextFrame_4>::size;
	using std::vector<TrainHitsAnotherTrainNextFrame_4>::begin;
	using std::vector<TrainHitsAnotherTrainNextFrame_4>::end;
	...
	{
		PB_TrainHitsAnotherTrainNextFrame_4Vector pbFrameVector;
...
#endif /*  VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_NEXT_FRAME_4_H_ */
