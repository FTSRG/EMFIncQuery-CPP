#ifndef VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_44_H_
#define VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_44_H_
...
class TrainHitsAnotherTrainFrame_44Vector;

struct TrainHitsAnotherTrainFrame_44 {
	
	using PBFrame = PB_TrainHitsAnotherTrainFrame_44;
	using FrameVector = TrainHitsAnotherTrainFrame_44Vector;
	...
	{
		PB_TrainHitsAnotherTrainFrame_44 pbframe;
...
class TrainHitsAnotherTrainFrame_44Vector 
	: private std::vector<TrainHitsAnotherTrainFrame_44>
{
	public:
	using std::vector<TrainHitsAnotherTrainFrame_44>::push_back;
	using std::vector<TrainHitsAnotherTrainFrame_44>::clear;
	using std::vector<TrainHitsAnotherTrainFrame_44>::empty;
	using std::vector<TrainHitsAnotherTrainFrame_44>::size;
	using std::vector<TrainHitsAnotherTrainFrame_44>::begin;
	using std::vector<TrainHitsAnotherTrainFrame_44>::end;
	...
	{
		PB_TrainHitsAnotherTrainFrame_44Vector pbFrameVector;
...
#endif /*  VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_44_H_ */
