#ifndef VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_108_H_
#define VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_108_H_
...
class TrainHitsAnotherTrainFrame_108Vector;

struct TrainHitsAnotherTrainFrame_108 {
	
	using PBFrame = PB_TrainHitsAnotherTrainFrame_108;
	using FrameVector = TrainHitsAnotherTrainFrame_108Vector;
	...
	{
		PB_TrainHitsAnotherTrainFrame_108 pbframe;
...
class TrainHitsAnotherTrainFrame_108Vector 
	: private std::vector<TrainHitsAnotherTrainFrame_108>
{
	public:
	using std::vector<TrainHitsAnotherTrainFrame_108>::push_back;
	using std::vector<TrainHitsAnotherTrainFrame_108>::clear;
	using std::vector<TrainHitsAnotherTrainFrame_108>::empty;
	using std::vector<TrainHitsAnotherTrainFrame_108>::size;
	using std::vector<TrainHitsAnotherTrainFrame_108>::begin;
	using std::vector<TrainHitsAnotherTrainFrame_108>::end;
	...
	{
		PB_TrainHitsAnotherTrainFrame_108Vector pbFrameVector;
...
#endif /*  VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_108_H_ */
