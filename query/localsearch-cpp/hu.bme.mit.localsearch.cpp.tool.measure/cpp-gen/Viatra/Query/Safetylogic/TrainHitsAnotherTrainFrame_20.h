#ifndef VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_20_H_
#define VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_20_H_
...
class TrainHitsAnotherTrainFrame_20Vector;

struct TrainHitsAnotherTrainFrame_20 {
	
	using PBFrame = PB_TrainHitsAnotherTrainFrame_20;
	using FrameVector = TrainHitsAnotherTrainFrame_20Vector;
	...
	{
		PB_TrainHitsAnotherTrainFrame_20 pbframe;
...
class TrainHitsAnotherTrainFrame_20Vector 
	: private std::vector<TrainHitsAnotherTrainFrame_20>
{
	public:
	using std::vector<TrainHitsAnotherTrainFrame_20>::push_back;
	using std::vector<TrainHitsAnotherTrainFrame_20>::clear;
	using std::vector<TrainHitsAnotherTrainFrame_20>::empty;
	using std::vector<TrainHitsAnotherTrainFrame_20>::size;
	using std::vector<TrainHitsAnotherTrainFrame_20>::begin;
	using std::vector<TrainHitsAnotherTrainFrame_20>::end;
	...
	{
		PB_TrainHitsAnotherTrainFrame_20Vector pbFrameVector;
...
#endif /*  VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_20_H_ */
