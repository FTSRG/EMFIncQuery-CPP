#ifndef VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_94_H_
#define VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_94_H_
...
class TrainHitsAnotherTrainFrame_94Vector;

struct TrainHitsAnotherTrainFrame_94 {
	
	using PBFrame = PB_TrainHitsAnotherTrainFrame_94;
	using FrameVector = TrainHitsAnotherTrainFrame_94Vector;
	...
	{
		PB_TrainHitsAnotherTrainFrame_94 pbframe;
...
class TrainHitsAnotherTrainFrame_94Vector 
	: private std::vector<TrainHitsAnotherTrainFrame_94>
{
	public:
	using std::vector<TrainHitsAnotherTrainFrame_94>::push_back;
	using std::vector<TrainHitsAnotherTrainFrame_94>::clear;
	using std::vector<TrainHitsAnotherTrainFrame_94>::empty;
	using std::vector<TrainHitsAnotherTrainFrame_94>::size;
	using std::vector<TrainHitsAnotherTrainFrame_94>::begin;
	using std::vector<TrainHitsAnotherTrainFrame_94>::end;
	...
	{
		PB_TrainHitsAnotherTrainFrame_94Vector pbFrameVector;
...
#endif /*  VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_94_H_ */
