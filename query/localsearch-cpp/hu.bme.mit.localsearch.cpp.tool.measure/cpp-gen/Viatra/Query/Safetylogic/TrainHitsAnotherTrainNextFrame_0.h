#ifndef VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_NEXT_FRAME_0_H_
#define VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_NEXT_FRAME_0_H_
...
class TrainHitsAnotherTrainNextFrame_0Vector;

struct TrainHitsAnotherTrainNextFrame_0 {
	
	using PBFrame = PB_TrainHitsAnotherTrainNextFrame_0;
	using FrameVector = TrainHitsAnotherTrainNextFrame_0Vector;
	...
	{
		PB_TrainHitsAnotherTrainNextFrame_0 pbframe;
...
class TrainHitsAnotherTrainNextFrame_0Vector 
	: private std::vector<TrainHitsAnotherTrainNextFrame_0>
{
	public:
	using std::vector<TrainHitsAnotherTrainNextFrame_0>::push_back;
	using std::vector<TrainHitsAnotherTrainNextFrame_0>::clear;
	using std::vector<TrainHitsAnotherTrainNextFrame_0>::empty;
	using std::vector<TrainHitsAnotherTrainNextFrame_0>::size;
	using std::vector<TrainHitsAnotherTrainNextFrame_0>::begin;
	using std::vector<TrainHitsAnotherTrainNextFrame_0>::end;
	...
	{
		PB_TrainHitsAnotherTrainNextFrame_0Vector pbFrameVector;
...
#endif /*  VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_NEXT_FRAME_0_H_ */
