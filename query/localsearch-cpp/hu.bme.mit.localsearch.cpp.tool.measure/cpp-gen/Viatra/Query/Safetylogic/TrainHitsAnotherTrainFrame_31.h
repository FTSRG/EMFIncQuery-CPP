#ifndef VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_31_H_
#define VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_31_H_
...
class TrainHitsAnotherTrainFrame_31Vector;

struct TrainHitsAnotherTrainFrame_31 {
	
	using PBFrame = PB_TrainHitsAnotherTrainFrame_31;
	using FrameVector = TrainHitsAnotherTrainFrame_31Vector;
	...
	{
		PB_TrainHitsAnotherTrainFrame_31 pbframe;
...
class TrainHitsAnotherTrainFrame_31Vector 
	: private std::vector<TrainHitsAnotherTrainFrame_31>
{
	public:
	using std::vector<TrainHitsAnotherTrainFrame_31>::push_back;
	using std::vector<TrainHitsAnotherTrainFrame_31>::clear;
	using std::vector<TrainHitsAnotherTrainFrame_31>::empty;
	using std::vector<TrainHitsAnotherTrainFrame_31>::size;
	using std::vector<TrainHitsAnotherTrainFrame_31>::begin;
	using std::vector<TrainHitsAnotherTrainFrame_31>::end;
	...
	{
		PB_TrainHitsAnotherTrainFrame_31Vector pbFrameVector;
...
#endif /*  VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_31_H_ */
