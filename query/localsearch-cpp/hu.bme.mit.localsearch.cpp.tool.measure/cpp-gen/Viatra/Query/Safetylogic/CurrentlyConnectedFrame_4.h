#ifndef VIATRA__QUERY__SAFETYLOGIC__CURRENTLY_CONNECTED_FRAME_4_H_
#define VIATRA__QUERY__SAFETYLOGIC__CURRENTLY_CONNECTED_FRAME_4_H_
...
class CurrentlyConnectedFrame_4Vector;

struct CurrentlyConnectedFrame_4 {
	
	using PBFrame = PB_CurrentlyConnectedFrame_4;
	using FrameVector = CurrentlyConnectedFrame_4Vector;
	...
	{
		PB_CurrentlyConnectedFrame_4 pbframe;
...
class CurrentlyConnectedFrame_4Vector 
	: private std::vector<CurrentlyConnectedFrame_4>
{
	public:
	using std::vector<CurrentlyConnectedFrame_4>::push_back;
	using std::vector<CurrentlyConnectedFrame_4>::clear;
	using std::vector<CurrentlyConnectedFrame_4>::empty;
	using std::vector<CurrentlyConnectedFrame_4>::size;
	using std::vector<CurrentlyConnectedFrame_4>::begin;
	using std::vector<CurrentlyConnectedFrame_4>::end;
	...
	{
		PB_CurrentlyConnectedFrame_4Vector pbFrameVector;
...
#endif /*  VIATRA__QUERY__SAFETYLOGIC__CURRENTLY_CONNECTED_FRAME_4_H_ */
