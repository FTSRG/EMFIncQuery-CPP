#ifndef VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_27_H_
#define VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_27_H_
...
class TrainHitsAnotherTrainFrame_27Vector;

struct TrainHitsAnotherTrainFrame_27 {
	
	using PBFrame = PB_TrainHitsAnotherTrainFrame_27;
	using FrameVector = TrainHitsAnotherTrainFrame_27Vector;
	...
	{
		PB_TrainHitsAnotherTrainFrame_27 pbframe;
...
class TrainHitsAnotherTrainFrame_27Vector 
	: private std::vector<TrainHitsAnotherTrainFrame_27>
{
	public:
	using std::vector<TrainHitsAnotherTrainFrame_27>::push_back;
	using std::vector<TrainHitsAnotherTrainFrame_27>::clear;
	using std::vector<TrainHitsAnotherTrainFrame_27>::empty;
	using std::vector<TrainHitsAnotherTrainFrame_27>::size;
	using std::vector<TrainHitsAnotherTrainFrame_27>::begin;
	using std::vector<TrainHitsAnotherTrainFrame_27>::end;
	...
	{
		PB_TrainHitsAnotherTrainFrame_27Vector pbFrameVector;
...
#endif /*  VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_27_H_ */
