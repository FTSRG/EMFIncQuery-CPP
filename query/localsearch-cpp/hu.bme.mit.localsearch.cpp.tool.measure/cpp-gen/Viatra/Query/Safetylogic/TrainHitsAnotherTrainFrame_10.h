#ifndef VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_10_H_
#define VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_10_H_
...
class TrainHitsAnotherTrainFrame_10Vector;

struct TrainHitsAnotherTrainFrame_10 {
	
	using PBFrame = PB_TrainHitsAnotherTrainFrame_10;
	using FrameVector = TrainHitsAnotherTrainFrame_10Vector;
	...
	{
		PB_TrainHitsAnotherTrainFrame_10 pbframe;
...
class TrainHitsAnotherTrainFrame_10Vector 
	: private std::vector<TrainHitsAnotherTrainFrame_10>
{
	public:
	using std::vector<TrainHitsAnotherTrainFrame_10>::push_back;
	using std::vector<TrainHitsAnotherTrainFrame_10>::clear;
	using std::vector<TrainHitsAnotherTrainFrame_10>::empty;
	using std::vector<TrainHitsAnotherTrainFrame_10>::size;
	using std::vector<TrainHitsAnotherTrainFrame_10>::begin;
	using std::vector<TrainHitsAnotherTrainFrame_10>::end;
	...
	{
		PB_TrainHitsAnotherTrainFrame_10Vector pbFrameVector;
...
#endif /*  VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_10_H_ */
