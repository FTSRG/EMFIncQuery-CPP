#ifndef VIATRA__QUERY__SAFETYLOGIC__CURRENTLY_CONNECTED_FRAME_2_H_
#define VIATRA__QUERY__SAFETYLOGIC__CURRENTLY_CONNECTED_FRAME_2_H_
...
class CurrentlyConnectedFrame_2Vector;

struct CurrentlyConnectedFrame_2 {
	
	using PBFrame = PB_CurrentlyConnectedFrame_2;
	using FrameVector = CurrentlyConnectedFrame_2Vector;
	...
	{
		PB_CurrentlyConnectedFrame_2 pbframe;
...
class CurrentlyConnectedFrame_2Vector 
	: private std::vector<CurrentlyConnectedFrame_2>
{
	public:
	using std::vector<CurrentlyConnectedFrame_2>::push_back;
	using std::vector<CurrentlyConnectedFrame_2>::clear;
	using std::vector<CurrentlyConnectedFrame_2>::empty;
	using std::vector<CurrentlyConnectedFrame_2>::size;
	using std::vector<CurrentlyConnectedFrame_2>::begin;
	using std::vector<CurrentlyConnectedFrame_2>::end;
	...
	{
		PB_CurrentlyConnectedFrame_2Vector pbFrameVector;
...
#endif /*  VIATRA__QUERY__SAFETYLOGIC__CURRENTLY_CONNECTED_FRAME_2_H_ */
