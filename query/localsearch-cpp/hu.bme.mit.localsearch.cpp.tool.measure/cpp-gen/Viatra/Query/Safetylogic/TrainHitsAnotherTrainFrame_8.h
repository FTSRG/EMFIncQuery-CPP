#ifndef VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_8_H_
#define VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_8_H_
...
class TrainHitsAnotherTrainFrame_8Vector;

struct TrainHitsAnotherTrainFrame_8 {
	
	using PBFrame = PB_TrainHitsAnotherTrainFrame_8;
	using FrameVector = TrainHitsAnotherTrainFrame_8Vector;
	...
	{
		PB_TrainHitsAnotherTrainFrame_8 pbframe;
...
class TrainHitsAnotherTrainFrame_8Vector 
	: private std::vector<TrainHitsAnotherTrainFrame_8>
{
	public:
	using std::vector<TrainHitsAnotherTrainFrame_8>::push_back;
	using std::vector<TrainHitsAnotherTrainFrame_8>::clear;
	using std::vector<TrainHitsAnotherTrainFrame_8>::empty;
	using std::vector<TrainHitsAnotherTrainFrame_8>::size;
	using std::vector<TrainHitsAnotherTrainFrame_8>::begin;
	using std::vector<TrainHitsAnotherTrainFrame_8>::end;
	...
	{
		PB_TrainHitsAnotherTrainFrame_8Vector pbFrameVector;
...
#endif /*  VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_8_H_ */
