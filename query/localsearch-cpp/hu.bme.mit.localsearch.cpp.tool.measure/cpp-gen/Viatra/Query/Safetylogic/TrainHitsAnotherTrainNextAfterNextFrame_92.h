#ifndef VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_NEXT_AFTER_NEXT_FRAME_92_H_
#define VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_NEXT_AFTER_NEXT_FRAME_92_H_
...
class TrainHitsAnotherTrainNextAfterNextFrame_92Vector;

struct TrainHitsAnotherTrainNextAfterNextFrame_92 {
	
	using PBFrame = PB_TrainHitsAnotherTrainNextAfterNextFrame_92;
	using FrameVector = TrainHitsAnotherTrainNextAfterNextFrame_92Vector;
	...
	::railRoadModel::ISegment* _8 = nullptr;
	...
	{
		PB_TrainHitsAnotherTrainNextAfterNextFrame_92 pbframe;
	...
	void ParseFromString(std::string str, ModelRoot *mr)
	{
		...
		_8 = (pbframe._8() == -1) 
			? nullptr 
			: dynamic_cast<::railRoadModel::ISegment*>(mr->findModelElementByID(pbframe._8()));
...
class TrainHitsAnotherTrainNextAfterNextFrame_92Vector 
	: private std::vector<TrainHitsAnotherTrainNextAfterNextFrame_92>
{
	public:
	using std::vector<TrainHitsAnotherTrainNextAfterNextFrame_92>::push_back;
	using std::vector<TrainHitsAnotherTrainNextAfterNextFrame_92>::clear;
	using std::vector<TrainHitsAnotherTrainNextAfterNextFrame_92>::empty;
	using std::vector<TrainHitsAnotherTrainNextAfterNextFrame_92>::size;
	using std::vector<TrainHitsAnotherTrainNextAfterNextFrame_92>::begin;
	using std::vector<TrainHitsAnotherTrainNextAfterNextFrame_92>::end;
	...
	{
		PB_TrainHitsAnotherTrainNextAfterNextFrame_92Vector pbFrameVector;
...
#endif /*  VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_NEXT_AFTER_NEXT_FRAME_92_H_ */
