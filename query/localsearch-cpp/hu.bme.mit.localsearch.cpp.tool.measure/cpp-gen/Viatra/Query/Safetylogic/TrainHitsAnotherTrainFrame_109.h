#ifndef VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_109_H_
#define VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_109_H_
...
class TrainHitsAnotherTrainFrame_109Vector;

struct TrainHitsAnotherTrainFrame_109 {
	
	using PBFrame = PB_TrainHitsAnotherTrainFrame_109;
	using FrameVector = TrainHitsAnotherTrainFrame_109Vector;
	...
	{
		PB_TrainHitsAnotherTrainFrame_109 pbframe;
...
class TrainHitsAnotherTrainFrame_109Vector 
	: private std::vector<TrainHitsAnotherTrainFrame_109>
{
	public:
	using std::vector<TrainHitsAnotherTrainFrame_109>::push_back;
	using std::vector<TrainHitsAnotherTrainFrame_109>::clear;
	using std::vector<TrainHitsAnotherTrainFrame_109>::empty;
	using std::vector<TrainHitsAnotherTrainFrame_109>::size;
	using std::vector<TrainHitsAnotherTrainFrame_109>::begin;
	using std::vector<TrainHitsAnotherTrainFrame_109>::end;
	...
	{
		PB_TrainHitsAnotherTrainFrame_109Vector pbFrameVector;
...
#endif /*  VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_109_H_ */
