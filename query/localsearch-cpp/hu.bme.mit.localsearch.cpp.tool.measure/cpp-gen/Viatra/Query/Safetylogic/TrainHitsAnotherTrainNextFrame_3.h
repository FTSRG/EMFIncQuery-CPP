#ifndef VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_NEXT_FRAME_3_H_
#define VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_NEXT_FRAME_3_H_
...
class TrainHitsAnotherTrainNextFrame_3Vector;

struct TrainHitsAnotherTrainNextFrame_3 {
	
	using PBFrame = PB_TrainHitsAnotherTrainNextFrame_3;
	using FrameVector = TrainHitsAnotherTrainNextFrame_3Vector;
	...
	{
		PB_TrainHitsAnotherTrainNextFrame_3 pbframe;
...
class TrainHitsAnotherTrainNextFrame_3Vector 
	: private std::vector<TrainHitsAnotherTrainNextFrame_3>
{
	public:
	using std::vector<TrainHitsAnotherTrainNextFrame_3>::push_back;
	using std::vector<TrainHitsAnotherTrainNextFrame_3>::clear;
	using std::vector<TrainHitsAnotherTrainNextFrame_3>::empty;
	using std::vector<TrainHitsAnotherTrainNextFrame_3>::size;
	using std::vector<TrainHitsAnotherTrainNextFrame_3>::begin;
	using std::vector<TrainHitsAnotherTrainNextFrame_3>::end;
	...
	{
		PB_TrainHitsAnotherTrainNextFrame_3Vector pbFrameVector;
...
#endif /*  VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_NEXT_FRAME_3_H_ */
