#ifndef VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_69_H_
#define VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_69_H_
...
class TrainHitsAnotherTrainFrame_69Vector;

struct TrainHitsAnotherTrainFrame_69 {
	
	using PBFrame = PB_TrainHitsAnotherTrainFrame_69;
	using FrameVector = TrainHitsAnotherTrainFrame_69Vector;
	...
	{
		PB_TrainHitsAnotherTrainFrame_69 pbframe;
...
class TrainHitsAnotherTrainFrame_69Vector 
	: private std::vector<TrainHitsAnotherTrainFrame_69>
{
	public:
	using std::vector<TrainHitsAnotherTrainFrame_69>::push_back;
	using std::vector<TrainHitsAnotherTrainFrame_69>::clear;
	using std::vector<TrainHitsAnotherTrainFrame_69>::empty;
	using std::vector<TrainHitsAnotherTrainFrame_69>::size;
	using std::vector<TrainHitsAnotherTrainFrame_69>::begin;
	using std::vector<TrainHitsAnotherTrainFrame_69>::end;
	...
	{
		PB_TrainHitsAnotherTrainFrame_69Vector pbFrameVector;
...
#endif /*  VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_69_H_ */
