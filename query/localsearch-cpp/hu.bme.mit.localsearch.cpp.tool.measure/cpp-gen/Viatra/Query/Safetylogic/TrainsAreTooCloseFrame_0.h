#ifndef VIATRA__QUERY__SAFETYLOGIC__TRAINS_ARE_TOO_CLOSE_FRAME_0_H_
#define VIATRA__QUERY__SAFETYLOGIC__TRAINS_ARE_TOO_CLOSE_FRAME_0_H_
...
class TrainsAreTooCloseFrame_0Vector;

struct TrainsAreTooCloseFrame_0 {
	
	using PBFrame = PB_TrainsAreTooCloseFrame_0;
	using FrameVector = TrainsAreTooCloseFrame_0Vector;
	...
	{
		PB_TrainsAreTooCloseFrame_0 pbframe;
...
class TrainsAreTooCloseFrame_0Vector 
	: private std::vector<TrainsAreTooCloseFrame_0>
{
	public:
	using std::vector<TrainsAreTooCloseFrame_0>::push_back;
	using std::vector<TrainsAreTooCloseFrame_0>::clear;
	using std::vector<TrainsAreTooCloseFrame_0>::empty;
	using std::vector<TrainsAreTooCloseFrame_0>::size;
	using std::vector<TrainsAreTooCloseFrame_0>::begin;
	using std::vector<TrainsAreTooCloseFrame_0>::end;
	...
	{
		PB_TrainsAreTooCloseFrame_0Vector pbFrameVector;
...
#endif /*  VIATRA__QUERY__SAFETYLOGIC__TRAINS_ARE_TOO_CLOSE_FRAME_0_H_ */
