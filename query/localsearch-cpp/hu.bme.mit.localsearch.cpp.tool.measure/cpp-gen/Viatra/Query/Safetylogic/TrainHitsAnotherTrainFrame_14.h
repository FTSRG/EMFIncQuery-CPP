#ifndef VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_14_H_
#define VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_14_H_
...
class TrainHitsAnotherTrainFrame_14Vector;

struct TrainHitsAnotherTrainFrame_14 {
	
	using PBFrame = PB_TrainHitsAnotherTrainFrame_14;
	using FrameVector = TrainHitsAnotherTrainFrame_14Vector;
	...
	{
		PB_TrainHitsAnotherTrainFrame_14 pbframe;
...
class TrainHitsAnotherTrainFrame_14Vector 
	: private std::vector<TrainHitsAnotherTrainFrame_14>
{
	public:
	using std::vector<TrainHitsAnotherTrainFrame_14>::push_back;
	using std::vector<TrainHitsAnotherTrainFrame_14>::clear;
	using std::vector<TrainHitsAnotherTrainFrame_14>::empty;
	using std::vector<TrainHitsAnotherTrainFrame_14>::size;
	using std::vector<TrainHitsAnotherTrainFrame_14>::begin;
	using std::vector<TrainHitsAnotherTrainFrame_14>::end;
	...
	{
		PB_TrainHitsAnotherTrainFrame_14Vector pbFrameVector;
...
#endif /*  VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_14_H_ */
