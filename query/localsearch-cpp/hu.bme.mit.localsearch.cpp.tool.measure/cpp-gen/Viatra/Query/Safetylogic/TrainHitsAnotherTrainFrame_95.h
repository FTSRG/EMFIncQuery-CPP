#ifndef VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_95_H_
#define VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_95_H_
...
class TrainHitsAnotherTrainFrame_95Vector;

struct TrainHitsAnotherTrainFrame_95 {
	
	using PBFrame = PB_TrainHitsAnotherTrainFrame_95;
	using FrameVector = TrainHitsAnotherTrainFrame_95Vector;
	...
	{
		PB_TrainHitsAnotherTrainFrame_95 pbframe;
...
class TrainHitsAnotherTrainFrame_95Vector 
	: private std::vector<TrainHitsAnotherTrainFrame_95>
{
	public:
	using std::vector<TrainHitsAnotherTrainFrame_95>::push_back;
	using std::vector<TrainHitsAnotherTrainFrame_95>::clear;
	using std::vector<TrainHitsAnotherTrainFrame_95>::empty;
	using std::vector<TrainHitsAnotherTrainFrame_95>::size;
	using std::vector<TrainHitsAnotherTrainFrame_95>::begin;
	using std::vector<TrainHitsAnotherTrainFrame_95>::end;
	...
	{
		PB_TrainHitsAnotherTrainFrame_95Vector pbFrameVector;
...
#endif /*  VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_95_H_ */
