#ifndef VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_80_H_
#define VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_80_H_
...
class TrainHitsAnotherTrainFrame_80Vector;

struct TrainHitsAnotherTrainFrame_80 {
	
	using PBFrame = PB_TrainHitsAnotherTrainFrame_80;
	using FrameVector = TrainHitsAnotherTrainFrame_80Vector;
	...
	{
		PB_TrainHitsAnotherTrainFrame_80 pbframe;
...
class TrainHitsAnotherTrainFrame_80Vector 
	: private std::vector<TrainHitsAnotherTrainFrame_80>
{
	public:
	using std::vector<TrainHitsAnotherTrainFrame_80>::push_back;
	using std::vector<TrainHitsAnotherTrainFrame_80>::clear;
	using std::vector<TrainHitsAnotherTrainFrame_80>::empty;
	using std::vector<TrainHitsAnotherTrainFrame_80>::size;
	using std::vector<TrainHitsAnotherTrainFrame_80>::begin;
	using std::vector<TrainHitsAnotherTrainFrame_80>::end;
	...
	{
		PB_TrainHitsAnotherTrainFrame_80Vector pbFrameVector;
...
#endif /*  VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_80_H_ */
