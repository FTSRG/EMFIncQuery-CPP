#ifndef VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_47_H_
#define VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_47_H_
...
class TrainHitsAnotherTrainFrame_47Vector;

struct TrainHitsAnotherTrainFrame_47 {
	
	using PBFrame = PB_TrainHitsAnotherTrainFrame_47;
	using FrameVector = TrainHitsAnotherTrainFrame_47Vector;
	...
	{
		PB_TrainHitsAnotherTrainFrame_47 pbframe;
...
class TrainHitsAnotherTrainFrame_47Vector 
	: private std::vector<TrainHitsAnotherTrainFrame_47>
{
	public:
	using std::vector<TrainHitsAnotherTrainFrame_47>::push_back;
	using std::vector<TrainHitsAnotherTrainFrame_47>::clear;
	using std::vector<TrainHitsAnotherTrainFrame_47>::empty;
	using std::vector<TrainHitsAnotherTrainFrame_47>::size;
	using std::vector<TrainHitsAnotherTrainFrame_47>::begin;
	using std::vector<TrainHitsAnotherTrainFrame_47>::end;
	...
	{
		PB_TrainHitsAnotherTrainFrame_47Vector pbFrameVector;
...
#endif /*  VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_47_H_ */
