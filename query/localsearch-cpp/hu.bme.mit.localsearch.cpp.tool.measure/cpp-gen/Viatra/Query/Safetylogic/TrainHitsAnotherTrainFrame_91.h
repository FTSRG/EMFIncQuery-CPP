#ifndef VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_91_H_
#define VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_91_H_
...
class TrainHitsAnotherTrainFrame_91Vector;

struct TrainHitsAnotherTrainFrame_91 {
	
	using PBFrame = PB_TrainHitsAnotherTrainFrame_91;
	using FrameVector = TrainHitsAnotherTrainFrame_91Vector;
	...
	{
		PB_TrainHitsAnotherTrainFrame_91 pbframe;
...
class TrainHitsAnotherTrainFrame_91Vector 
	: private std::vector<TrainHitsAnotherTrainFrame_91>
{
	public:
	using std::vector<TrainHitsAnotherTrainFrame_91>::push_back;
	using std::vector<TrainHitsAnotherTrainFrame_91>::clear;
	using std::vector<TrainHitsAnotherTrainFrame_91>::empty;
	using std::vector<TrainHitsAnotherTrainFrame_91>::size;
	using std::vector<TrainHitsAnotherTrainFrame_91>::begin;
	using std::vector<TrainHitsAnotherTrainFrame_91>::end;
	...
	{
		PB_TrainHitsAnotherTrainFrame_91Vector pbFrameVector;
...
#endif /*  VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_91_H_ */
