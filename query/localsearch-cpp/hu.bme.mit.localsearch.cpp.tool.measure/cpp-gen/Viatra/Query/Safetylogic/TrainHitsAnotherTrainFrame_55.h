#ifndef VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_55_H_
#define VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_55_H_
...
class TrainHitsAnotherTrainFrame_55Vector;

struct TrainHitsAnotherTrainFrame_55 {
	
	using PBFrame = PB_TrainHitsAnotherTrainFrame_55;
	using FrameVector = TrainHitsAnotherTrainFrame_55Vector;
	...
	::railRoadModel::ISegment* _14 = nullptr;
	// toString
	...
	{
		PB_TrainHitsAnotherTrainFrame_55 pbframe;
	...
	void ParseFromString(std::string str, ModelRoot *mr)
	{
		...
		_14 = (pbframe._14() == -1) 
			? nullptr 
			: dynamic_cast<::railRoadModel::ISegment*>(mr->findModelElementByID(pbframe._14()));
		
	}
};
		
class TrainHitsAnotherTrainFrame_55Vector 
	: private std::vector<TrainHitsAnotherTrainFrame_55>
{
	public:
	using std::vector<TrainHitsAnotherTrainFrame_55>::push_back;
	using std::vector<TrainHitsAnotherTrainFrame_55>::clear;
	using std::vector<TrainHitsAnotherTrainFrame_55>::empty;
	using std::vector<TrainHitsAnotherTrainFrame_55>::size;
	using std::vector<TrainHitsAnotherTrainFrame_55>::begin;
	using std::vector<TrainHitsAnotherTrainFrame_55>::end;
	...
	{
		PB_TrainHitsAnotherTrainFrame_55Vector pbFrameVector;
...
#endif /*  VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_55_H_ */
