#ifndef VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_NEXT_AFTER_NEXT_FRAME_7_H_
#define VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_NEXT_AFTER_NEXT_FRAME_7_H_
...
class TrainHitsAnotherTrainNextAfterNextFrame_7Vector;

struct TrainHitsAnotherTrainNextAfterNextFrame_7 {
	
	using PBFrame = PB_TrainHitsAnotherTrainNextAfterNextFrame_7;
	using FrameVector = TrainHitsAnotherTrainNextAfterNextFrame_7Vector;
	...
	::railRoadModel::ISegment* _9 = nullptr;
	...
	{
		PB_TrainHitsAnotherTrainNextAfterNextFrame_7 pbframe;
	...
	void ParseFromString(std::string str, ModelRoot *mr)
	{
		...
		_9 = (pbframe._9() == -1) 
			? nullptr 
			: dynamic_cast<::railRoadModel::ISegment*>(mr->findModelElementByID(pbframe._9()));
...
class TrainHitsAnotherTrainNextAfterNextFrame_7Vector 
	: private std::vector<TrainHitsAnotherTrainNextAfterNextFrame_7>
{
	public:
	using std::vector<TrainHitsAnotherTrainNextAfterNextFrame_7>::push_back;
	using std::vector<TrainHitsAnotherTrainNextAfterNextFrame_7>::clear;
	using std::vector<TrainHitsAnotherTrainNextAfterNextFrame_7>::empty;
	using std::vector<TrainHitsAnotherTrainNextAfterNextFrame_7>::size;
	using std::vector<TrainHitsAnotherTrainNextAfterNextFrame_7>::begin;
	using std::vector<TrainHitsAnotherTrainNextAfterNextFrame_7>::end;
	...
	{
		PB_TrainHitsAnotherTrainNextAfterNextFrame_7Vector pbFrameVector;
...
#endif /*  VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_NEXT_AFTER_NEXT_FRAME_7_H_ */
