#ifndef VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_68_H_
#define VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_68_H_
...
class TrainHitsAnotherTrainFrame_68Vector;

struct TrainHitsAnotherTrainFrame_68 {
	
	using PBFrame = PB_TrainHitsAnotherTrainFrame_68;
	using FrameVector = TrainHitsAnotherTrainFrame_68Vector;
	...
	{
		PB_TrainHitsAnotherTrainFrame_68 pbframe;
...
class TrainHitsAnotherTrainFrame_68Vector 
	: private std::vector<TrainHitsAnotherTrainFrame_68>
{
	public:
	using std::vector<TrainHitsAnotherTrainFrame_68>::push_back;
	using std::vector<TrainHitsAnotherTrainFrame_68>::clear;
	using std::vector<TrainHitsAnotherTrainFrame_68>::empty;
	using std::vector<TrainHitsAnotherTrainFrame_68>::size;
	using std::vector<TrainHitsAnotherTrainFrame_68>::begin;
	using std::vector<TrainHitsAnotherTrainFrame_68>::end;
	...
	{
		PB_TrainHitsAnotherTrainFrame_68Vector pbFrameVector;
...
#endif /*  VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_68_H_ */
