#ifndef VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_NEXT_FRAME_6_H_
#define VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_NEXT_FRAME_6_H_
...
class TrainHitsAnotherTrainNextFrame_6Vector;

struct TrainHitsAnotherTrainNextFrame_6 {
	
	using PBFrame = PB_TrainHitsAnotherTrainNextFrame_6;
	using FrameVector = TrainHitsAnotherTrainNextFrame_6Vector;
	...
	{
		PB_TrainHitsAnotherTrainNextFrame_6 pbframe;
...
class TrainHitsAnotherTrainNextFrame_6Vector 
	: private std::vector<TrainHitsAnotherTrainNextFrame_6>
{
	public:
	using std::vector<TrainHitsAnotherTrainNextFrame_6>::push_back;
	using std::vector<TrainHitsAnotherTrainNextFrame_6>::clear;
	using std::vector<TrainHitsAnotherTrainNextFrame_6>::empty;
	using std::vector<TrainHitsAnotherTrainNextFrame_6>::size;
	using std::vector<TrainHitsAnotherTrainNextFrame_6>::begin;
	using std::vector<TrainHitsAnotherTrainNextFrame_6>::end;
	...
	{
		PB_TrainHitsAnotherTrainNextFrame_6Vector pbFrameVector;
...
#endif /*  VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_NEXT_FRAME_6_H_ */
