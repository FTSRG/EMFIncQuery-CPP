#ifndef VIATRA__QUERY__SAFETYLOGIC__NEXT_SECTION_FRAME_4_H_
#define VIATRA__QUERY__SAFETYLOGIC__NEXT_SECTION_FRAME_4_H_
...
class NextSectionFrame_4Vector;

struct NextSectionFrame_4 {
	
	using PBFrame = PB_NextSectionFrame_4;
	using FrameVector = NextSectionFrame_4Vector;
...
class NextSectionFrame_4Vector 
	: private std::vector<NextSectionFrame_4>
{
	public:
	using std::vector<NextSectionFrame_4>::push_back;
	using std::vector<NextSectionFrame_4>::clear;
	using std::vector<NextSectionFrame_4>::empty;
	using std::vector<NextSectionFrame_4>::size;
	using std::vector<NextSectionFrame_4>::begin;
	using std::vector<NextSectionFrame_4>::end;
	...
	{
		PB_NextSectionFrame_4Vector pbFrameVector;
...
#endif /*  VIATRA__QUERY__SAFETYLOGIC__NEXT_SECTION_FRAME_4_H_ */
