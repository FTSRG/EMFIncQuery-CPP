#ifndef VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_58_H_
#define VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_58_H_
...
class TrainHitsAnotherTrainFrame_58Vector;

struct TrainHitsAnotherTrainFrame_58 {
	
	using PBFrame = PB_TrainHitsAnotherTrainFrame_58;
	using FrameVector = TrainHitsAnotherTrainFrame_58Vector;
	...
	{
		PB_TrainHitsAnotherTrainFrame_58 pbframe;
...
class TrainHitsAnotherTrainFrame_58Vector 
	: private std::vector<TrainHitsAnotherTrainFrame_58>
{
	public:
	using std::vector<TrainHitsAnotherTrainFrame_58>::push_back;
	using std::vector<TrainHitsAnotherTrainFrame_58>::clear;
	using std::vector<TrainHitsAnotherTrainFrame_58>::empty;
	using std::vector<TrainHitsAnotherTrainFrame_58>::size;
	using std::vector<TrainHitsAnotherTrainFrame_58>::begin;
	using std::vector<TrainHitsAnotherTrainFrame_58>::end;
	...
	{
		PB_TrainHitsAnotherTrainFrame_58Vector pbFrameVector;
...
#endif /*  VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_58_H_ */
