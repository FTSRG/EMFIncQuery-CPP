#ifndef VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_102_H_
#define VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_102_H_
...
class TrainHitsAnotherTrainFrame_102Vector;

struct TrainHitsAnotherTrainFrame_102 {
	
	using PBFrame = PB_TrainHitsAnotherTrainFrame_102;
	using FrameVector = TrainHitsAnotherTrainFrame_102Vector;
	...
	{
		PB_TrainHitsAnotherTrainFrame_102 pbframe;
...
class TrainHitsAnotherTrainFrame_102Vector 
	: private std::vector<TrainHitsAnotherTrainFrame_102>
{
	public:
	using std::vector<TrainHitsAnotherTrainFrame_102>::push_back;
	using std::vector<TrainHitsAnotherTrainFrame_102>::clear;
	using std::vector<TrainHitsAnotherTrainFrame_102>::empty;
	using std::vector<TrainHitsAnotherTrainFrame_102>::size;
	using std::vector<TrainHitsAnotherTrainFrame_102>::begin;
	using std::vector<TrainHitsAnotherTrainFrame_102>::end;
	...
	{
		PB_TrainHitsAnotherTrainFrame_102Vector pbFrameVector;
...
#endif /*  VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_102_H_ */
