#ifndef VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_16_H_
#define VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_16_H_
...
class TrainHitsAnotherTrainFrame_16Vector;

struct TrainHitsAnotherTrainFrame_16 {
	
	using PBFrame = PB_TrainHitsAnotherTrainFrame_16;
	using FrameVector = TrainHitsAnotherTrainFrame_16Vector;
	...
	std::string toString() const
	{
		...
		ret += ",trainHitsAnotherTrainNextAfterNext<0>_nextSection<1>_viablePaths<0>_connected2=";
		...
		ret += ",trainHitsAnotherTrainNextAfterNext<0>_nextSection<1>_viablePaths<0>_connected1=";
	...
	{
		PB_TrainHitsAnotherTrainFrame_16 pbframe;
...
class TrainHitsAnotherTrainFrame_16Vector 
	: private std::vector<TrainHitsAnotherTrainFrame_16>
{
	public:
	using std::vector<TrainHitsAnotherTrainFrame_16>::push_back;
	using std::vector<TrainHitsAnotherTrainFrame_16>::clear;
	using std::vector<TrainHitsAnotherTrainFrame_16>::empty;
	using std::vector<TrainHitsAnotherTrainFrame_16>::size;
	using std::vector<TrainHitsAnotherTrainFrame_16>::begin;
	using std::vector<TrainHitsAnotherTrainFrame_16>::end;
	...
	{
		PB_TrainHitsAnotherTrainFrame_16Vector pbFrameVector;
...
#endif /*  VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_16_H_ */
