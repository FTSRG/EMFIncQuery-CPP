#ifndef VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_79_H_
#define VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_79_H_
...
class TrainHitsAnotherTrainFrame_79Vector;

struct TrainHitsAnotherTrainFrame_79 {
	
	using PBFrame = PB_TrainHitsAnotherTrainFrame_79;
	using FrameVector = TrainHitsAnotherTrainFrame_79Vector;
	...
	{
		PB_TrainHitsAnotherTrainFrame_79 pbframe;
...
class TrainHitsAnotherTrainFrame_79Vector 
	: private std::vector<TrainHitsAnotherTrainFrame_79>
{
	public:
	using std::vector<TrainHitsAnotherTrainFrame_79>::push_back;
	using std::vector<TrainHitsAnotherTrainFrame_79>::clear;
	using std::vector<TrainHitsAnotherTrainFrame_79>::empty;
	using std::vector<TrainHitsAnotherTrainFrame_79>::size;
	using std::vector<TrainHitsAnotherTrainFrame_79>::begin;
	using std::vector<TrainHitsAnotherTrainFrame_79>::end;
	...
	{
		PB_TrainHitsAnotherTrainFrame_79Vector pbFrameVector;
...
#endif /*  VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_79_H_ */
