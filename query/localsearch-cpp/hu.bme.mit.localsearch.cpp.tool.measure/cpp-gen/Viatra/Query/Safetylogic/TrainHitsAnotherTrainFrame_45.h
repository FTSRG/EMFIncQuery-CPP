#ifndef VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_45_H_
#define VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_45_H_
...
class TrainHitsAnotherTrainFrame_45Vector;

struct TrainHitsAnotherTrainFrame_45 {
	
	using PBFrame = PB_TrainHitsAnotherTrainFrame_45;
	using FrameVector = TrainHitsAnotherTrainFrame_45Vector;
	...
	{
		PB_TrainHitsAnotherTrainFrame_45 pbframe;
...
class TrainHitsAnotherTrainFrame_45Vector 
	: private std::vector<TrainHitsAnotherTrainFrame_45>
{
	public:
	using std::vector<TrainHitsAnotherTrainFrame_45>::push_back;
	using std::vector<TrainHitsAnotherTrainFrame_45>::clear;
	using std::vector<TrainHitsAnotherTrainFrame_45>::empty;
	using std::vector<TrainHitsAnotherTrainFrame_45>::size;
	using std::vector<TrainHitsAnotherTrainFrame_45>::begin;
	using std::vector<TrainHitsAnotherTrainFrame_45>::end;
	...
	{
		PB_TrainHitsAnotherTrainFrame_45Vector pbFrameVector;
...
#endif /*  VIATRA__QUERY__SAFETYLOGIC__TRAIN_HITS_ANOTHER_TRAIN_FRAME_45_H_ */
