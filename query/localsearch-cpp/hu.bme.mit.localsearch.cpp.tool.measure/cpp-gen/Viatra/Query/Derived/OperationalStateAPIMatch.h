#ifndef VIATRA__QUERY__DERIVED__OPERATIONAL_STATE_A_P_I_MATCH_H_
#define VIATRA__QUERY__DERIVED__OPERATIONAL_STATE_A_P_I_MATCH_H_
...
template<> struct hash<::Viatra::Query::Derived::OperationalStateAPIMatch> {
	size_t operator()(const ::Viatra::Query::Derived::OperationalStateAPIMatch& match) const {
		size_t h = 0;
...
#endif /*  VIATRA__QUERY__DERIVED__OPERATIONAL_STATE_A_P_I_MATCH_H_ */
