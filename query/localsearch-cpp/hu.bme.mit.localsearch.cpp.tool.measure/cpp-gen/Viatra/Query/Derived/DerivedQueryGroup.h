#ifndef VIATRA__QUERY__DERIVED__DERIVED_QUERY_GROUP_H_
#define VIATRA__QUERY__DERIVED__DERIVED_QUERY_GROUP_H_
...
class DerivedQueryGroup{
public:
	static DerivedQueryGroup* instance() {
		static DerivedQueryGroup instance;
		return &instance;
	}
...
#endif /*  VIATRA__QUERY__DERIVED__DERIVED_QUERY_GROUP_H_ */
