#ifndef VIATRA__QUERY__ITERATOR_QUERY__ITERATOR_QUERY_QUERY_GROUP_H_
#define VIATRA__QUERY__ITERATOR_QUERY__ITERATOR_QUERY_QUERY_GROUP_H_
...
class IteratorQueryQueryGroup{
public:
	static IteratorQueryQueryGroup* instance() {
		static IteratorQueryQueryGroup instance;
		return &instance;
	}
...
#endif /*  VIATRA__QUERY__ITERATOR_QUERY__ITERATOR_QUERY_QUERY_GROUP_H_ */
