#ifndef VIATRA__QUERY__DERIVED_INPUT__VERY_CLOSE_MATCH_H_
#define VIATRA__QUERY__DERIVED_INPUT__VERY_CLOSE_MATCH_H_
...
struct VeryCloseMatch {
	...
	bool operator==(const VeryCloseMatch& other) const {
		return 
...
template<> struct hash<::Viatra::Query::DerivedInput::VeryCloseMatch> {
	size_t operator()(const ::Viatra::Query::DerivedInput::VeryCloseMatch& match) const {
		return 
...
#endif /*  VIATRA__QUERY__DERIVED_INPUT__VERY_CLOSE_MATCH_H_ */
