 ...
 * </p>
 * <ul>
 *   <li>{@link RailRoadModel.impl.RailRoadElementImpl#getId <em>Id</em>}</li>
 *   <li>{@link RailRoadModel.impl.RailRoadElementImpl#getPoints <em>Points</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class RailRoadElementImpl extends MinimalEObjectImpl.Container implements RailRoadElement {
	...
	protected EClass eStaticClass() {
		return RailRoadModelPackage.Literals.RAIL_ROAD_ELEMENT;
	}
	...
	public void setId(int newId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RailRoadModelPackage.RAIL_ROAD_ELEMENT__ID, oldId, id));
	}
