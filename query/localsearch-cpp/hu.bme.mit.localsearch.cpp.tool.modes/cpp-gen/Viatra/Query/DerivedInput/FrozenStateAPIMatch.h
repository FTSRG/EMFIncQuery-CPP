#ifndef VIATRA__QUERY__DERIVED_INPUT__FROZEN_STATE_A_P_I_MATCH_H_
...
template<> struct hash<::Viatra::Query::DerivedInput::FrozenStateAPIMatch> {
	size_t operator()(const ::Viatra::Query::DerivedInput::FrozenStateAPIMatch& match) const {
		size_t h = 0;
...
#endif /*  VIATRA__QUERY__DERIVED_INPUT__FROZEN_STATE_A_P_I_MATCH_H_ */
