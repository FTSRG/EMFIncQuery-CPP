#ifndef VIATRA__QUERY__DERIVED_INPUT__NEAR_BY_MATCH_H_
#define VIATRA__QUERY__DERIVED_INPUT__NEAR_BY_MATCH_H_
...
template<> struct hash<::Viatra::Query::DerivedInput::NearByMatch> {
	size_t operator()(const ::Viatra::Query::DerivedInput::NearByMatch& match) const {
		size_t h = 0;
...
#endif /*  VIATRA__QUERY__DERIVED_INPUT__NEAR_BY_MATCH_H_ */
