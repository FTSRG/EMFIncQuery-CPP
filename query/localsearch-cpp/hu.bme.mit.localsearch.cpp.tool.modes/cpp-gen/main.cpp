...
void init(){
	...
	auto t1001 = new Train(); t1001->id = 1001; model.trains.push_back(t1001);
	auto t1002 = new Train(); t1002->id = 1002; model.trains.push_back(t1002);
...
int main(int argc, char**argv)
{
	...
	Viatra::Query::ModelRoot modelRoot;
	...
	try {
		...
		{
			std::cout << std::fixed << std::setprecision(10) << record.checkTime << ";";
		}
