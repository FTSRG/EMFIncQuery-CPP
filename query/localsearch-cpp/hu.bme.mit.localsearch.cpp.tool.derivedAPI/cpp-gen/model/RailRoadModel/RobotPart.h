...
public:
	...
	virtual ~IRobotPart() {}
	static constexpr unsigned short type_id = 14;
	...
	virtual void set_nearBy(std::vector< ::RailRoadModel::Train* > newVal) = 0;
	virtual std::vector< ::RailRoadModel::Train* > nearBy() = 0;
	virtual void set_refSegment(::RailRoadModel::Segment* newVal) = 0;
	virtual ::RailRoadModel::Segment* refSegment() = 0;
};
...
public:
	...
	void set_nearBy(std::vector< ::RailRoadModel::Train* > newVal) override;
	std::vector< ::RailRoadModel::Train* > nearBy() override;
	void set_refSegment(::RailRoadModel::Segment* newVal) override;
	::RailRoadModel::Segment* refSegment() override;
...
private:
	...
	std::vector< ::RailRoadModel::Train* > _nearBy;
	::RailRoadModel::Segment* _refSegment = nullptr;
