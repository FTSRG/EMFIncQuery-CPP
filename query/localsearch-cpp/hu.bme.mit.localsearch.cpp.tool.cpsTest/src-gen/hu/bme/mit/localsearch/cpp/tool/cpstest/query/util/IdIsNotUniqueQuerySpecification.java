...
import hu.bme.mit.localsearch.cpp.tool.cpstest.query.util.IdentifiableIdQuerySpecification;
...
public final class IdIsNotUniqueQuerySpecification extends BaseGeneratedEMFQuerySpecification<IdIsNotUniqueMatcher> {
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    ...
    public String getFullyQualifiedName() {
      return "hu.bme.mit.localsearch.cpp.tool.cpstest.query.idIsNotUnique";
    }
    ...
    public List<PParameter> getParameters() {
      return Arrays.asList(
      			 new PParameter("identifiable", "org.eclipse.viatra.examples.cps.cyberPhysicalSystem.Identifiable")
      			);
    }
