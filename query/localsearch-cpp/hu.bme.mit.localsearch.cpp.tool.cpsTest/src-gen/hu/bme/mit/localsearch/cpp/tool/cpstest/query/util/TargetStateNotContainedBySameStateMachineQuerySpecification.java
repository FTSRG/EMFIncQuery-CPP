...
import hu.bme.mit.localsearch.cpp.tool.cpstest.query.util.StateTransitionQuerySpecification;
...
public final class TargetStateNotContainedBySameStateMachineQuerySpecification extends BaseGeneratedEMFQuerySpecification<TargetStateNotContainedBySameStateMachineMatcher> {
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    ...
    public String getFullyQualifiedName() {
      return "hu.bme.mit.localsearch.cpp.tool.cpstest.query.targetStateNotContainedBySameStateMachine";
    }
    ...
    public List<PParameter> getParameters() {
      return Arrays.asList(
      			 ...
      			 new PParameter("target", "org.eclipse.viatra.examples.cps.cyberPhysicalSystem.State")
      			);
    }
