...
inline NavigateMultiAssociation<SrcType, MemberTrgType, Collection, Member, MatchingFrame, NavigatorTrgType>::NavigateMultiAssociation(SrcGetter getSrc, MemberToBind bindMember, Navigator navigate)
